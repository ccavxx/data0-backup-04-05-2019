...
function calcAgeCommon201516(dob) {
...
function gotoNextPage() {
	...
	var disabledPages=main.isDisabledForNext(currentPage,totalPage);
	if(disabledPages > 0)
	{
...
function gotoPrevPage() {
	...
	document.getElementById("currentPage").value=--currentPage;
	var disabledPages=main.isDisabledForNext(currentPage,2);
