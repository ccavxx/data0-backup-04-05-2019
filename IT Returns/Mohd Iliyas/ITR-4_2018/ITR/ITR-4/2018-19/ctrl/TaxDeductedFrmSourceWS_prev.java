...
public class TaxDeductedFrmSourceWS_prev  implements Initializable{
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		if(OnChangeUtil.getElementValueByTargetName("itr.itr4.tdsDtls26QC.tds26ASStmtPANFlag26QC").equals("Y"))
		{
			tds26ASStmtPANFlag1.setText("Yes");
		}
		else if(OnChangeUtil.getElementValueByTargetName("itr.itr4.tdsDtls26QC.tds26ASStmtPANFlag26QC").equals("N"))
		{
			tds26ASStmtPANFlag1.setText("No");
		}
		
		if(OnChangeUtil.getElementValueByTargetName("itr.itr4.tdsDtls26QC.tds26ASStmtOtherPANFlag26QC").equals("Y"))
		{
			tds26ASStmtAnotherPANFlag.setText("Yes");
		}
		else if(OnChangeUtil.getElementValueByTargetName("itr.itr4.tdsDtls26QC.tds26ASStmtOtherPANFlag26QC").equals("N"))
		{
	...
	/*	
		...
		//	HeadofIncForTax.setText(td.getHeadofIncForTax().toString());
			...
			ApportioningReason.setText(ComboBoxOptionsCacher.getValueForKey("reasonQC1",td.getApportioningReason()));
		...
		if(OnChangeUtil.getElementValueByTargetName("itr.itr4.tdsDtls26QC.totalTDSDetails26QC").toString().equals("empty"))
		{
			total.setText("0");
		}
		else
		{
			total.setText(OnChangeUtil.getElementValueByTargetName("itr.itr4.tdsDtls26QC.totalTDSDetails26QC"));
		}
