...
public class colorPane implements Initializable {
						...
						if(k>1.0)
						{
						   ...
						   // label1.setStyle("-fx-font-size:"+k+"em;");
						    ...
						    label9.setStyle("-fx-font-size:"+k+"em;");
							 if(label10!=null && k>=1.3)
						    label10.setStyle("-fx-font-size:"+k+"em;");
							 if(label11!=null && k>=1.3){
								  ...
								  label52.setStyle("-fx-font-size:"+k+"em;");
								   ...
								   label57.setStyle("-fx-font-size:"+k+"em;");
								    ...
								    if(label61!=null && k>=1.3)
								    {
								    label61.setStyle("-fx-font-size:"+k+"em;");
								    }
								    if(label64!=null && k>=1.3)
								    {
		   ...
		   increaseButton.setOnKeyPressed(new EventHandler<KeyEvent>() {
				...
				public void handle(KeyEvent keyEvent) {
					...
					if(k1<1.8)
				    {
						...
						if(label64!=null)
					    {
					    label64.setStyle("-fx-font-size:"+k1+"em;");
					    }
						
						if(label15!=null)
						 {
					    label15.setStyle("-fx-font-size:"+k1+"em;");
						 }
					    ...
					    label12.setStyle("-fx-font-size:"+k1+"em;");
						 ...
						 if(label13!=null)
						 {
					    label13.setStyle("-fx-font-size:"+k1+"em;");
						 }
						 if(label61!=null)
						    {
						    label61.setStyle("-fx-font-size:"+k1+"em;");
						    }
						 if(label56!=null)
						    {
						    label56.setStyle("-fx-font-size:"+k1+"em;");
						    }
						  if(label37!=null)
						    {
						  ...
						  if(label14!=null)
							 {
						    label14.setStyle("-fx-font-size:"+k1+"em;");
							 }
