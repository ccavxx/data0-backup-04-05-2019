...
public class ScheduleCTTab1_Preview3 implements Initializable{
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		List<DtlsOfTransDurPrevYr> list =(List<DtlsOfTransDurPrevYr>) ValidationUtil.ALL_TVC.get("class com.itd.efiling.offline.ITR4.ctrl.Schedule_CT_Tab3").getTableView().getItems();
