...
public class ScheduleCTTab1_Preview4 implements Initializable{
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		List<DtlsOfTransDurPrevYr> list =(List<DtlsOfTransDurPrevYr>) ValidationUtil.ALL_TVC.get("class com.itd.efiling.offline.ITR4.ctrl.Schedule_CT_Tab4").getTableView().getItems();
