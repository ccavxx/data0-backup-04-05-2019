...
public class ScheduleCTTab1_Preview2 implements Initializable{
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		List<DtlsOfTransDurPrevYr> list =(List<DtlsOfTransDurPrevYr>) ValidationUtil.ALL_TVC.get("class com.itd.efiling.offline.ITR4.ctrl.Schedule_CT_Tab2").getTableView().getItems();
