 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="TaxPayableOnRebate">
 *           &lt;simpleType>
 *             &lt;restriction base="{http://www.w3.org/2001/XMLSchema}unsignedLong">
 *               &lt;totalDigits value="14"/>
 *             &lt;/restriction>
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="SurchargeOnAboveCrore">
 *           &lt;simpleType>
 *             &lt;restriction base="{http://www.w3.org/2001/XMLSchema}unsignedLong">
 *               &lt;totalDigits value="14"/>
 *             &lt;/restriction>
...
public class TaxComputation {
    ...
    @XmlElement(name = "Rebate87A", defaultValue = "0")
    protected BigInteger rebate87A;
    @XmlElement(name = "TaxPayableOnRebate", required = true, defaultValue = "0")
    protected BigInteger taxPayableOnRebate;
    @XmlElement(name = "SurchargeOnAboveCrore", required = true, defaultValue = "0")
    protected BigInteger surchargeOnAboveCrore;
    ...
    /**
     * Gets the value of the rebate87A property.
     * 
     */
    public BigInteger getRebate87A() {
        return rebate87A;
    }

    /**
     * Sets the value of the rebate87A property.
     * 
     */
    public void setRebate87A(BigInteger value) {
        this.rebate87A = value;
    }

    /**
     * Gets the value of the taxPayableOnRebate property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getTaxPayableOnRebate() {
        return taxPayableOnRebate;
    }

    /**
     * Sets the value of the taxPayableOnRebate property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setTaxPayableOnRebate(BigInteger value) {
        this.taxPayableOnRebate = value;
    }

    /**
     * Gets the value of the surchargeOnAboveCrore property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getSurchargeOnAboveCrore() {
        return surchargeOnAboveCrore;
    }

    /**
     * Sets the value of the surchargeOnAboveCrore property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setSurchargeOnAboveCrore(BigInteger value) {
        this.surchargeOnAboveCrore = value;
    }
