...
public class MovableAsset {
    ...
    @XmlElement(name = "DepositsInBank", required = true)
    protected BigInteger depositsInBank;
    @XmlElement(name = "SharesAndSecurities", required = true)
    protected BigInteger sharesAndSecurities;
    @XmlElement(name = "InsurancePolicies", required = true)
    protected BigInteger insurancePolicies;
    @XmlElement(name = "LoansAndAdvancesGiven", required = true)
    protected BigInteger loansAndAdvancesGiven;
    @XmlElement(name = "CashInHand", required = true)
    protected BigInteger cashInHand;
    @XmlElement(name = "JewelleryBullionEtc", required = true)
    protected BigInteger jewelleryBullionEtc;
    @XmlElement(name = "ArchCollDrawPaintSulpArt", required = true)
    protected BigInteger archCollDrawPaintSulpArt;
    @XmlElement(name = "VehiclYachtsBoatsAircrafts", required = true)
