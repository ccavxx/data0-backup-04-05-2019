...
@XmlRootElement(name = "Form_ITR4")
public class FormITR4 {
    ...
    public FormITR4() {
		super();
		this.formName = Configs.getConfigProperty("xml.form.name");
	   	this.assessmentYear= Configs.getConfigProperty("xml.assessment.year");
	    this.schemaVer = Configs.getConfigProperty("xml.schema.ver");
	    this.formVer = Configs.getConfigProperty("xml.form.version");
	    this.setDescription("For Individuals having Income From Presemptive Business");
	}
