...
var Filing_dueDate= '05/08/2016'; // Modified due to the due date extended for filing the return
var Int_start_date_234A = '06/08/2016'; // Modified due to the due date extended for filing the return
...
function calc44aeNobBp(tableId){
	try{
		...
		document.getElementsByName('itr4S.scheduleBPForITR4S.persumptiveInc44AD.grsTrnOverOrReceipt')[0].value 
			= coalesce(document.getElementsByName('itr4S.scheduleBPForITR4S.persumptiveInc44AD.grsTrnOverOrReceipt')[0].value );
		...
		document.getElementsByName('itr4S.scheduleBPForITR4S.incChargeableUnderBus')[0].value = coalesce(
				eval( parseInt(coalesce(document.getElementsByName('itr4S.scheduleBPForITR4S.persumptiveInc44AE.totalPersumptiveInc44AD')[0].value ) ,10) -
		...
		document.getElementsByName('itr4S.itr4SIncomeDeductions.incomeFromBusinessProf')[0].value = coalesce(
			coalesce(document.getElementsByName('itr4S.scheduleBPForITR4S.incChargeableUnderBus')[0].value ));
...
function dedUndVIA(){
	...
	if(residentialStatus=='NRI'){
		document.getElementsByName('itr4S.scheduleBPForITR4S.persumptiveInc44AD.grsTrnOverOrReceipt')[0].value=parseInt('0',10);
		document.getElementsByName('itr4S.scheduleBPForITR4S.persumptiveInc44AD.grsTrnOverOrReceipt')[0].readOnly=true;
		...
		document.getElementsByName('itr4S.scheduleBPForITR4S.persumptiveInc44AD.grsTrnOverOrReceipt')[0].readOnly=false;
		document.getElementsByName('itr4S.scheduleBPForITR4S.persumptiveInc44AD.totPersumptiveInc44AD')[0].readOnly=false;
	}
	...
	sec80GGsysCalc.value=0;
		...
		sec80DsysCalc,sec80DDsysCalc,sec80DDBsysCalc,sec80EsysCalc,sec80GsysCalc,sec80GGCsysCalc,
...
function calcTI(){
 ...
 var rebate87A = document.getElementsByName('itr4S.itr1TaxComputationOnline.rebate87A')[0];
	...
	var taxPayableOnRebate = document.getElementsByName('itr4S.itr1TaxComputationOnline.taxPayableOnRebate')[0]; 
...
// for surcharge
			...
			if( rndOffNrsTen(totInc.value) > 10000000 ){
				var tempSurcharge = taxOnTotInc  * 0.12 ; //surcharge change for 16-17
...
function calcEduCess(){
	...
	var totInc = document.getElementsByName('itr4S.itr4sTaxComputationOnline.totalTaxPayable')[0];
	var eduCess = document.getElementsByName('itr4S.itr4sTaxComputationOnline.educationCess')[0];
	var taxPayableOnRebate = document.getElementsByName('itr4S.itr1TaxComputationOnline.taxPayableOnRebate')[0].value; 
	var surchargeOnAboveCrore = document.getElementsByName('itr4S.itr1TaxComputationOnline.surchargeOnAboveCrore')[0].value;
	if(totInc.value < 0){
	...
	var totTaxWithEduCess = document.getElementsByName('itr4S.itr4sTaxComputationOnline.grossTaxLiability')[0];
...
try{
	...
	if(portuVal=='N'){
		for(var i = 0; i < allInputTags.length; i++) {
				if (allInputTags[i].name.match("amtTCSClaimedThisYear$")) {
					if(eval(parseInt(coalesce(allInputTags[i].value),10)) >  parseInt(allInputTags[i-1].value,10)){
						addError(allInputTags[i],'Amount claimed in Col 4 cannot exceed Total tax collected',true);
							j.setFieldError(allInputTags[i].name,'Amount claimed in Col 4 cannot exceed Total tax collected');
						allInputTags[i].value = parseInt('0',10);
		...
		for(var i = 0; i < allInputTags.length; i++) {
				if (allInputTags[i].name.match("amtTCSClaimedThisYear$")&& allInputTags[i+1].name.match("amtClaimedBySpouse$")) {
					if(eval(parseInt(coalesce(allInputTags[i].value),10) + parseInt(coalesce(allInputTags[i+1].value),10)) >  parseInt(allInputTags[i-1].value,10)){
						addError(allInputTags[i],'Amount claimed in Col 4+Col 5 cannot exceed Total tax collected',true);
							j.setFieldError(allInputTags[i].name,'Amount claimed in Col 4+Col 5 cannot exceed Total tax collected');
						allInputTags[i].value = parseInt('0',10);
						allInputTags[i+1].value = parseInt('0',10);
						TCS = eval(parseInt(TCS ,10) + parseInt(isNVL(allInputTags[i].value) ,10));
					}else{
	...
	//Here get the value of virtualBalTaxPayableFor234B
	var virtualBalTaxPayableFor234B = calcVirtualTaxPayableOnTI();             //call the function to calculate virtualBalTaxPayable
	if(( eval(parseInt(virtualBalTaxPayableFor234B ,10) - parseInt(TDS ,10)- parseInt(TCS ,10)) >=  parseInt('10000',10))){

		if(parseInt(slab1 ,10) < eval((parseInt(virtualBalTaxPayableFor234B ,10) - parseInt(TDS ,10) - parseInt(TCS ,10)) * parseFloat('0.3'))){
			var tempintrst234Ci = (((parseInt(virtualBalTaxPayableFor234B ,10) - parseInt(TDS ,10)- parseInt(TCS ,10) ) * parseFloat('0.30')) - parseInt(slab1 ,10));
		...
		if(eval(parseInt(slab1 ,10) + parseInt(slab2 ,10)) < eval((parseInt(virtualBalTaxPayableFor234B ,10) - parseInt(TDS ,10)- parseInt(TCS ,10)) * parseFloat('0.6') )){
		var tempintrst234Cii = (((parseInt(virtualBalTaxPayableFor234B ,10) - parseInt(TDS ,10)- parseInt(TCS ,10)) * parseFloat('0.6') ) -parseInt(slab1 ,10) - parseInt(slab2 ,10) );
		...
		if(eval(parseInt(slab1 ,10) + parseInt(slab2 ,10) + parseInt(slab3 ,10)) < eval((parseInt(virtualBalTaxPayableFor234B ,10) - parseInt(TDS ,10)- parseInt(TCS ,10)) * parseInt('1' ,10))){
			var tempintrst234Ciii = ((parseInt(virtualBalTaxPayableFor234B ,10) - parseInt(TDS ,10)- parseInt(TCS ,10)) - parseInt(slab1 ,10)- parseInt(slab2 ,10) - parseInt(slab3 ,10) );
	...
	if(parseInt(virtualBalTaxPayableFor234B,10) - parseInt(TDS,10)- parseInt(TCS,10) >= parseInt('10000' ,10)) {
		if(parseInt(advanceTax,10) < ((parseInt(virtualBalTaxPayableFor234B,10) - parseInt(TDS,10) - parseInt(TCS,10)) * parseFloat('0.90'))) {

			intrst234Bprinciple = (parseInt(virtualBalTaxPayableFor234B ,10) - parseInt(advanceTax ,10) - parseInt(TDS,10)- parseInt(TCS,10) );
			// Rounding off to previous hundered
			...
			if( parseInt(intrst234Bprinciple,10) > 0 ){
				...
				if(selfAsspaidDates.length!=0){
					...
					for(var i = 0; i < selfAsspaidDates.length; i++) {
						...
						intrst234Bprinciple2=zeroOrMore(eval(parseInt(virtualBalTaxPayableFor234B ,10) - parseInt(advanceTax ,10) - parseInt(TDS,10)- parseInt(TCS,10) +
...
function returnFile_UnderSec(type){
	...
	if(type != 'onload' && val == '20'){
		addErrorXHTML('','Section 139 read with section 119(2)(b) for AY 2016-17 can be filed only after 31st March 2018.');
	}
	if(val=='18')
	{
...
function calcVirtualTaxPayableOnTI(){
 ...
 var resStatus=document.getElementsByName('itr4S.filingStatus.residentialStatus')[0].value;
	...
	if((resStatus=='RES') && salInt.value > 0){
		
		var temp = eval(parseInt(salInt.value,10) - parseInt( totPersumInc44AE.value ,10));
		if(temp > 0){
			
			var virtualpresInc44AD = eval(parseInt( presInc44AD.value ,10) -  parseInt(temp,10)) ;
			virtualpresInc44AD= Math.max(0, virtualpresInc44AD);
		}
		else{
			
			virtualpresInc44AD =  parseInt( presInc44AD.value ,10);
		}
		
		virtualTotInc = eval(parseInt(totInc.value,10) - parseInt(virtualpresInc44AD ,10));
	}
	else
...
function onGenderChange(){
	...
	var status = document.getElementsByName('itr4S.personalInfo.status')[0];
	if(gender.value == 'S' ||gender.value == 'M' ||gender.value == 'F' ||gender.value == 'T'){
...
function onStatusChange(){
	...
	if(status.value == 'I' ){
		...
		gender.options[0] = new Option('Select','S');
...
function checkNob(){
	...
	var turnOverE1=document.getElementsByName('itr4S.scheduleBPForITR4S.persumptiveInc44AD.grsTrnOverOrReceipt')[0].value;
	var presumInc=document.getElementsByName('itr4S.scheduleBPForITR4S.persumptiveInc44AD.totPersumptiveInc44AD')[0].value;
	
	var turnOver8=eval(parseInt(coalesce(turnOverE1)) * .08);
	
	if(presumInc>0 && turnOverE1 ==0 || turnOverE1==''){
		
		addErrorXHTML('' ,'Gross turn over or gross receipts is mandatory and cannot be zero');	
		j.setFieldError('itr4S.scheduleBPForITR4S.persumptiveInc44AD.grsTrnOverOrReceipt','Gross turn over or gross receipts is mandatory and cannot be zero');
		
	}else if(presumInc < turnOver8){
		
		addErrorXHTML('' ,'Total presumptive income under 44AD must be greater than 8% of E1');	
		j.setFieldError('itr4S.scheduleBPForITR4S.persumptiveInc44AD.totPersumptiveInc44AD','Total presumptive income under 44AD must be greater than 8% of E1');
...
if((pan.substring(3,4)=='P' || pan.substring(3,4)=='p') && (status == 'H' || status == 'F')){
		addErrorXHTML('' ,'Since PAN entered is Individual PAN, Select Status in A15 as Individual');	
		j.setFieldError('itr4S.personalInfo.pan','Since PAN entered is Individual PAN, Select Status in A15 as Individual');
		} else if((pan.substring(3,4)=='H' || pan.substring(3,4)=='h') && (status == 'I' || status == 'F')){
	addErrorXHTML('' ,'Since PAN entered is HUF PAN, Select Status in A15 as HUF');	
	j.setFieldError('itr4S.personalInfo.pan','Since PAN entered is HUF PAN, Select Status in A15 as HUF');
	}
	else if((pan.substring(3,4)=='F' || pan.substring(3,4)=='f') && (status == 'I' || status == 'H')){
			addErrorXHTML('' ,'Since PAN entered is Firm PAN, Select Status in A15 as Firm');	
			j.setFieldError('itr4S.personalInfo.pan','Since PAN entered is Firm PAN, Select Status in A15 as Firm');
	}
}
...
//Display error message for GTI if GTI is less than 0
	...
	if( parseInt(grossTotalIncome ,10) <0 ){
	 grossTotalIncome = parseInt(0,10);
	 addErrorXHTML('','To avail the benefit of carry forward and set off of loss, please use ITR-4.');
	}
	}
	
//Display error message for presumptive Income
	
	function presumtive8PerCheck(){
	var grossTrnOverOrRcpt = document.getElementsByName('itr4S.scheduleBPForITR4S.persumptiveInc44AD.grsTrnOverOrReceipt')[0].value;
	var totalPresumptv44AD = document.getElementsByName('itr4S.scheduleBPForITR4S.persumptiveInc44AD.totPersumptiveInc44AD')[0].value;
		
	if(parseInt(totalPresumptv44AD,10) > parseInt(grossTrnOverOrRcpt,10)){
	addErrorXHTML('' ,'E2 should not be greater than E1');	
	j.setFieldError('itr4S.scheduleBPForITR4S.persumptiveInc44AD.totPersumptiveInc44AD','E2 should not be greater than E1');
	}
	}
...
if(totalIncome>10000000){
		...
		addError('',' If income E1 is more than Rs 1 crore (Gross Receipts), it is mandatory to have a tax audit under 44AB. Please use the regular ITR 4 form.',true);
		j.setFieldError('','If income E1 is more than Rs 1 crore (Gross Receipts), it is mandatory to have a tax audit under 44AB. Please use the regular ITR 4 form.');
...
function displaywarnings(){
	...
	if(sec119=='20'){
		errText+=(i++)+". Section 139 read with section 119(2)(b) for AY 2016-17 can be filed only after 31st March 2018\n\n";
	}
...
function calc44AD(){
	...
	document.getElementsByName('itr4S.scheduleBPForITR4S.persumptiveInc44AE.totalPersumptiveInc44AD')[0].value = coalesce(
			eval( parseInt(coalesce(document.getElementsByName('itr4S.scheduleBPForITR4S.persumptiveInc44AD.totPersumptiveInc44AD')[0].value ) ,10) +
				  parseInt(coalesce(document.getElementsByName('itr4S.scheduleBPForITR4S.persumptiveInc44AE.totPersumInc44AE')[0].value ) ,10)));
...
function disableAL(){
	...
	if(status == 'F'){
		...
		document.getElementsByName('scheduleAL.immovableAssetLand')[0].disabled=true;
		document.getElementsByName('scheduleAL.immovableAssetLand')[0].readOnly=true;
		document.getElementsByName('scheduleAL.immovableAssetLand')[0].value='';
		document.getElementsByName('scheduleAL.immovableAssetBuilding')[0].disabled=true;
		document.getElementsByName('scheduleAL.immovableAssetBuilding')[0].readOnly=true;
		document.getElementsByName('scheduleAL.immovableAssetBuilding')[0].value='';
		document.getElementsByName('scheduleAL.movableAsset.cashInHand')[0].disabled=true;
		document.getElementsByName('scheduleAL.movableAsset.cashInHand')[0].readOnly=true;
		document.getElementsByName('scheduleAL.movableAsset.cashInHand')[0].value='';
		document.getElementsByName('scheduleAL.movableAsset.jewelleryBullionEtc')[0].disabled=true;
		document.getElementsByName('scheduleAL.movableAsset.jewelleryBullionEtc')[0].readOnly=true;
		document.getElementsByName('scheduleAL.movableAsset.jewelleryBullionEtc')[0].value='';
		document.getElementsByName('scheduleAL.movableAsset.vehiclYachtsBoatsAircrafts')[0].disabled=true;
		document.getElementsByName('scheduleAL.movableAsset.vehiclYachtsBoatsAircrafts')[0].readOnly=true;
		document.getElementsByName('scheduleAL.movableAsset.vehiclYachtsBoatsAircrafts')[0].value='';
		document.getElementsByName('scheduleAL.movableAsset.totalImmovablMovablAssets')[0].disabled=true;
		document.getElementsByName('scheduleAL.movableAsset.totalImmovablMovablAssets')[0].readOnly=true;
		document.getElementsByName('scheduleAL.movableAsset.totalImmovablMovablAssets')[0].value='';
		document.getElementsByName('scheduleAL.liabilityInRelatAssets')[0].disabled=true;
		document.getElementsByName('scheduleAL.liabilityInRelatAssets')[0].readOnly=true;
		document.getElementsByName('scheduleAL.liabilityInRelatAssets')[0].value='';

	}
		else{
			
			document.getElementsByName('scheduleAL.immovableAssetLand')[0].disabled=false;
			document.getElementsByName('scheduleAL.immovableAssetLand')[0].readOnly=false;
			document.getElementsByName('scheduleAL.immovableAssetBuilding')[0].disabled=false;
			document.getElementsByName('scheduleAL.immovableAssetBuilding')[0].readOnly=false;
			document.getElementsByName('scheduleAL.movableAsset.cashInHand')[0].disabled=false;
			document.getElementsByName('scheduleAL.movableAsset.cashInHand')[0].readOnly=false;
			document.getElementsByName('scheduleAL.movableAsset.jewelleryBullionEtc')[0].disabled=false;
			document.getElementsByName('scheduleAL.movableAsset.jewelleryBullionEtc')[0].readOnly=false;
			document.getElementsByName('scheduleAL.movableAsset.vehiclYachtsBoatsAircrafts')[0].disabled=false;
			document.getElementsByName('scheduleAL.movableAsset.vehiclYachtsBoatsAircrafts')[0].readOnly=false;
			document.getElementsByName('scheduleAL.movableAsset.totalImmovablMovablAssets')[0].disabled=true;
			document.getElementsByName('scheduleAL.movableAsset.totalImmovablMovablAssets')[0].readOnly=true;
			document.getElementsByName('scheduleAL.liabilityInRelatAssets')[0].disabled=false;
			document.getElementsByName('scheduleAL.liabilityInRelatAssets')[0].readOnly=false;
		}
}
