...
function dedUndVIA(){
	...
	// CHECK FOR 80D	
	var age = calcAge();
	var option80D = document.getElementsByName('itr4S.itr4SIncomeDeductions.usrDeductUndChapVIA.section80DUsrType')[0].value;
	
	if( parseInt(grossTotInc ,10) >0 ){
	if(status =='I'){
		if(option80D == '1'){
			if( parseInt(sec80D,10) > eval('25000')){
				sec80DsysCalc.value = '25000';
			} else {
				sec80DsysCalc.value =  parseInt(sec80D,10);
			}
		}else if(option80D== '2' && (residentialStatus =='RES' || residentialStatus =='NOR')){
			...
			if( parseInt(sec80D,10) > eval('50000')){
				sec80DsysCalc.value = '50000';
			} else {
				sec80DsysCalc.value =  parseInt(sec80D,10);
			}
		}else if(option80D== '6'){
			...
			if(age > eval('59') && (residentialStatus =='RES' || residentialStatus =='NOR')){
...
try{
	...
	var age = calcAgeCommon(document.getElementsByName('itr4S.personalInfo.dob')[0]);
	var resStatus = document.getElementsByName('itr4S.filingStatus.residentialStatus')[0].value;
	var taxPayer = document.getElementsByName('itr4S.personalInfo.status')[0].value;
	var pan = document.getElementsByName('itr4S.personalInfo.pan')[0].value;

	var totBPInc = document.getElementsByName('itr4S.itr4SIncomeDeductions.incomeFromBusinessProf')[0].value;
...
function onStatusChangePrefill(){
	...
	if(status.value == 'I'){
		document.getElementsByName('itr4S.filingStatus.portugeseCC5A')[0].disabled = false;
		document.getElementsByName('itr4S.itr4SIncomeDeductions.usrDeductUndChapVIA.section80DUsrType')[0].disabled = false;
	} else{
		document.getElementsByName('itr4S.filingStatus.portugeseCC5A')[0].disabled = true;
    	document.getElementsByName('itr4S.filingStatus.portugeseCC5A')[0].value='';
		document.getElementsByName('itr4S.filingStatus.panOfSpouse')[0].disabled = true;
		document.getElementsByName('itr4S.filingStatus.panOfSpouse')[0].value='';
		document.getElementsByName('itr4S.itr4SIncomeDeductions.usrDeductUndChapVIA.section80DUsrType')[0].value = '';
		document.getElementsByName('itr4S.itr4SIncomeDeductions.usrDeductUndChapVIA.section80DUsrType')[0].disabled = true;
	}
...
function onStatusChange(){
	...
	if(status.value == 'I' ){
		...
		document.getElementsByName('itr4S.filingStatus.aadhaarEnrolmentId')[0].disabled = false;
		document.getElementsByName('itr4S.filingStatus.adharNumber')[0].disabled = false;
	...
	if(!(gender.value == 'M' || gender.value == 'F'|| gender.value == 'T')){
		...
		document.getElementsByName('itr4S.filingStatus.adharNumber')[0].value = '';
		document.getElementsByName('itr4S.filingStatus.adharNumber')[0].disabled = true;
		
		document.getElementsByName('itr4S.filingStatus.aadhaarEnrolmentId')[0].value = '';
		document.getElementsByName('itr4S.filingStatus.aadhaarEnrolmentId')[0].disabled = true;
...
//To check Nature of business to be mandatory or not..
function checkNatureOfBusiness(){
	
	var tab = document.getElementById('natOfBustTradeTableId');
	var rowCount = tab.rows.length;
	
	var persumptive44AD=document.getElementsByName('itr4S.scheduleBPForITR4S.persumptiveInc44AD.totPersumptiveInc44AD')[0].value; // E2c
	var persumptive44ADA=document.getElementsByName('itr4S.scheduleBPForITR4S.persumptiveInc44ADA.totPersumptiveInc44ADA')[0].value; //E4
	var persumptive44AE = document.getElementsByName('itr4S.scheduleBPForITR4S.persumptiveInc44AE.totPersumInc44AE')[0].value; //E5
	
	var totalIncome = eval(parseInt(persumptive44AD,10) + parseInt(coalesce(persumptive44ADA),10)+ parseInt(coalesce(persumptive44AE),10));
	
	if(totalIncome>0){
		for ( var i = 0; i < (rowCount - 2); i++) {
			var section = document.getElementsByName('itr4S.natOfBus.business[' + i	+ '].code')[0].value;
			
			if (section == '') {
				j.setFieldError('itr4S.natOfBus.business[' + i	+ '].code','Please select Nature of Business from the Drop Down.');
				//count1=count1+1;
			}
		}
	}
...
function scheduleALFirm(){
	
	var totalin = document.getElementsByName('itr4S.itr4SIncomeDeductions.totalIncome')[0].value; 
	var immflag = document.getElementsByName('itr4S.scheduleAL.immovableFlag')[0].value;
	var jewflag = document.getElementsByName('itr4S.scheduleAL.movableAsset.jewelleryBullionEtc')[0].value;
	var archflag = document.getElementsByName('itr4S.scheduleAL.movableAsset.archCollDrawPaintSulpArt')[0].value;
	var vehiflag = document.getElementsByName('itr4S.scheduleAL.movableAsset.vehiclYachtsBoatsAircrafts')[0].value;
	var deposflag = document.getElementsByName('itr4S.scheduleAL.movableAsset.depositsinbank')[0].value;
	var shreflag = document.getElementsByName('itr4S.scheduleAL.movableAsset.sharesandsecurities')[0].value;
	var insurflag = document.getElementsByName('itr4S.scheduleAL.movableAsset.insurancepolicies')[0].value;
	var loanflag = document.getElementsByName('itr4S.scheduleAL.movableAsset.loansandadvancesgiven')[0].value;
	var cashflag = document.getElementsByName('itr4S.scheduleAL.movableAsset.cashInHand')[0].value;
	var AOPflag = document.getElementsByName('itr4S.scheduleAL.interstAOPFlag')[0].value;
	var liabflag = document.getElementsByName('itr4S.scheduleAL.liabilityInRelatAssets')[0].value;
	var status = document.getElementsByName('itr4S.personalInfo.status')[0].value;
	
	if(totalin > 5000000 && status!='F')
		{
		
		if((immflag == "")||(jewflag =="")||(archflag =="")||(vehiflag =="") ||(deposflag =="") ||(shreflag =="") ||(insurflag =="") ||(loanflag =="")
					||(cashflag =="")||(AOPflag =="")||(liabflag =="")){
			
			addErrorXHTML('' ,'Please fill all the fields in schedule AL.');	
			j.setFieldError('itr4S.scheduleAL.immovableFlag','Please fill all the fields in schedule AL.');
		}
...
function mandtryAL(){
	...
	if ((immflag != ""))
	{
		if((jewflag =="")||(archflag =="")||(vehiflag =="") ||(deposflag =="") ||(shreflag =="") ||(insurflag =="") ||(loanflag =="")
			...
			addErrorXHTML('' ,'Please fill all the fields in schedule AL.');	
			j.setFieldError('itr4S.scheduleAL','Please fill all the fields in schedule AL.');}
...
function setCountryForStateItr4(){
...
function checkPinOnStateChangeVer()
{
	...
	if ( state.value == "99" || country.value != "91")
		{
		document.getElementsByName('itr4S.personalInfo.address.pinCode.pChosenCheckBox')[0].checked=false;
		document.getElementsByName('itr4S.personalInfo.address.pinCode.pChosenCheckBox')[0].disabled=false;
		document.getElementsByName('itr4S.personalInfo.address.pinCode')[0].disabled=true;
		document.getElementsByName('itr4S.personalInfo.address.pinCode')[0].value="";
		document.getElementsByName('itr4S.personalInfo.address.zipCode')[0].disabled=false;
		
		}
	else 
		{
		document.getElementsByName('itr4S.personalInfo.address.pinCode.pChosenCheckBox')[0].checked=false;
		document.getElementsByName('itr4S.personalInfo.address.pinCode.pChosenCheckBox')[0].disabled=true;
		document.getElementsByName('itr4S.personalInfo.address.pinCode')[0].disabled=false;
		document.getElementsByName('itr4S.personalInfo.address.zipCode')[0].disabled=true;
		document.getElementsByName('itr4S.personalInfo.address.zipCode')[0].value="";
		}
...
function checkPinOnCountryChangeVer()
{
	...
	var zipCode =document.getElementsByName('itr4S.personalInfo.address.zipCode')[0].value
...
function setStateForCountryitr4(){
...
function populateZipCodeVer(){
	...
	var zipCodeCheck= document.getElementsByName('itr4S.personalInfo.address.pinCode.pChosenCheckBox')[0];
	var country = document.getElementsByName('itr4S.personalInfo.address.country')[0];
	
	if(zipCodeCheck.checked==true && country.value !='91' && country.value !="" ){
		
		document.getElementsByName('itr4S.personalInfo.address.zipCode')[0].value="XXXXXX";
		document.getElementsByName('itr4S.personalInfo.address.zipCode')[0].readOnly=true;
		zipCodeCheck.value=true;
		
	}else{
		
		document.getElementsByName('itr4S.personalInfo.address.zipCode')[0].value="";
		document.getElementsByName('itr4S.personalInfo.address.zipCode')[0].readOnly=false;
...
function checkPinZipOnload()
{
	...
	if (country.value == "91" || country.value== "-1"){
		...
		if(zipCode=="XXXXXX"){
			...
			document.getElementsByName('itr4S.personalInfo.address.zipCode')[0].readOnly=true;
			document.getElementsByName('itr4S.personalInfo.address.pinCode.pChosenCheckBox')[0].checked=true;
		}else{
...
{
	var bankDtlflag = document.getElementsByName('itr4S.refund.scheduleBA.bankDtlsFlag')[0].value;
	var bankName = document.getElementsByName('itr4S.refund.depositToBankAccount.bankName')[0].value;
	var ifscCode = document.getElementsByName('itr4S.refund.depositToBankAccount.iFSCCode')[0].value;
	var bankAcctNo = document.getElementsByName('itr4S.refund.bankAccountNumber')[0].value;
	var cashDeposit = document.getElementsByName('itr4S.refund.depositToBankAccount.cashDeposited')[0].value;
	...
	if(bankDtlflag=='N' )
	{
		if(bankName !="" && (ifscCode=="" || bankAcctNo=="")){
			...
			j.setFieldError('itr4S.refund.depositToBankAccount','Please fill all the fields under Indian Bank Account details.');
		}
   ...
   if(cashDeposit !="" && (ifscCode=="" || bankAcctNo==""||bankName=="")){
	...
	for(var i = 0; i < allInputTags.length; i++) {
		if (allInputTags[i].name.match("ifscCode$") && allInputTags[i+1].name.match("bankName$") && allInputTags[i+2].name.match("accNo$") && allInputTags[i+3].name.match("cashDeposited$")) {
				if(allInputTags[i+3].value!='' && (allInputTags[i].value=='' || allInputTags[i+1].value=='' || allInputTags[i+2].value=='')){
					...
					j.setFieldError('itr4S.scheduleBA[0].ifscCode','Please fill all the fields under Other Bank account details.');
					//allInputTags[i].value = parseInt('0',10);
			}
		}
	}
...
{
	var aadharNo = document.getElementsByName('itr4S.filingStatus.adharNumber')[0].value;
...
//To enable/disable tables
function enableTableForBank(element, value, tableId) {
...
function enableBankDtls()
{
	...
	enableField('itr4S.refund.scheduleBA.bankDtlsFlag','Y','itr4S.refund.depositToBankAccount.iFSCCode');
	enableField('itr4S.refund.scheduleBA.bankDtlsFlag','Y','itr4S.refund.depositToBankAccount.bankName');
	enableField('itr4S.refund.scheduleBA.bankDtlsFlag','Y','itr4S.refund.bankAccountNumber');
	enableField('itr4S.refund.scheduleBA.bankDtlsFlag','Y','itr4S.refund.depositToBankAccount.cashDeposited');
	
	enableTableForBank('itr4S.refund.scheduleBA.bankDtlsFlag', 'Y','scheduleBA');
	
	enableField('itr4S.refund.scheduleBA.bankDtlsFlag','N','itr4S.refund.scheduleBA.foreignBankDtls[0].ibanSwiftCode');
	enableField('itr4S.refund.scheduleBA.bankDtlsFlag','N','itr4S.refund.scheduleBA.foreignBankDtls[0].bankName');
	enableField('itr4S.refund.scheduleBA.bankDtlsFlag','N','itr4S.refund.scheduleBA.foreignBankDtls[0].countryCode');
	enableField('itr4S.refund.scheduleBA.bankDtlsFlag','N','itr4S.refund.scheduleBA.foreignBankDtls[0].bankAccountNo');
...
function populateBankFlg()
{
	...
	if(residentialStatus == 'RES' || residentialStatus == 'NOR')
		{
		document.getElementsByName('itr4S.refund.scheduleBA.bankDtlsFlag')[0].value = 'Y';
		document.getElementsByName('itr4S.refund.scheduleBA.bankDtlsFlag')[0].disabled=true;
		}else
			{
			document.getElementsByName('itr4S.refund.scheduleBA.bankDtlsFlag')[0].disabled=false;
			}
	enableBankDtls();
}
...
{
	var age = calcAge();
	var sec80D  = document.getElementsByName('itr4S.itr4SIncomeDeductions.usrDeductUndChapVIA.section80DUsrType')[0].value;
	if( (sec80D == '2' || sec80D == '7' ) && age < 60)
		{
		j.setFieldError('itr4S.itr4SIncomeDeductions.usrDeductUndChapVIA.section80DUsrType','Please select a valid option from the dropdown of Sec.80D under Chapter VI-A');
...
function genWarningMsgForNRI() {
	...
	var resStatus = document.getElementsByName('itr4S.filingStatus.residentialStatus')[0].value;
	var bankDtlsFlg = document.getElementsByName('itr4S.refund.scheduleBA.bankDtlsFlag')[0].value;
	alert('inside NRI msg');
	if( resStatus == 'NRI' && bankDtlsFlg == 'N' ){
	  ...
	  j.setFieldError('itr4S.refund.scheduleBA.bankDtlsFlag','Currently refund will be credited to a bank account located in India and not to a bank account located in a foreign country.');
	}
}
