...
function setOffSTCGWithA9(cgosIncome) {
	...
	for(var i=0; i<noOfRows; i++){
		...
		else if(sectionValue=='A1e'||sectionValue=='A4b'||sectionValue=='A6f'||sectionValue=='A7' ||sectionValue=='A8' ||sectionValue=='A2c'){
...
function isDSCMandatory(){
	...
	while(document.getElementsByName('partAGEN2For4.natOfBus.business['+i+'].code')[0] && 
			document.getElementsByName('partAGEN2For4.natOfBus.business['+i+'].code')[0].value){
		if(document.getElementsByName('partAGEN2For4.natOfBus.business['+i+'].code')[0].value.match('060[1-7]')){
			limit=2500000;
