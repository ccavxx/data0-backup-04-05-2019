...
function addRows(fieldId,rowCount,type){
	...
	else if(fieldId.indexOf('scheduleS.salaries')!=-1 && fieldId.indexOf('salarys.otherAllowances.othersIncDtls')==-1 && window.addScheduleSalary){
		addScheduleSalaryOnImport();
			return true;
