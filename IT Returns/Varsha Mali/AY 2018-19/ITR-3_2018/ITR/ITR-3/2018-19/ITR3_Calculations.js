...
var Filing_dueDate = '31/07/2018'; // Modified due to the due date extended for filing the return
var Int_start_date_234A = '01/08/2018'; // Modified due to the due date extended for filing the return
...
function calcITR4Impl(){
	try{
	      ...
	      // OSSubCalInc();
		   ...
		   panValidationTDS2('scheduleTDS2');
		   panValidationTDS2('scheduleTDS3');
		   validateSalaryOtherAllowancesDesc();
...
function setOtherGrossSourceOnChangeDTAA() {
	...
	var allSectionArray = [ '56i', '56', '5A1ai', '5A1aii', '5A1aiia',
			...
			'5AC1ab', '5AD1i', '5AD1iP', '5BBA', '5Ea', '5BBG', '5BBDA',
			'5BBF', '1', '5BBC' ,'5ACA1a','5BB'];

	if ((status == 'RES' || status == 'NOR')&& ben115HFlg != 'Y' ){

		addAllOptionsDTAA(allSectionArray, rowCount);
		var sectionArray =['5A1ai','5A1aii','5A1aiia','5A1aiiaa','5A1aiiac','5A1aiiab','5A1aiii','5A1bA','5A1bB','5AC1ab','5BBA'];
		removeSectionOnChangeDTAA(sectionArray, rowCount);
	} else if (status == 'NRI') {

		addAllOptionsDTAA(allSectionArray, rowCount);
		var sectionArray = ['5BBDA','5BBF','5ACA1a'];
		removeSectionOnChangeDTAA(sectionArray, rowCount);
	}
...
function setOtherGrossSource() {
	...
	var allSectionArray = [ '5A1ai', '5A1aii', '5A1aiia', '5A1aiiaa',
	            			...
	            			'5ACA1a', '5AD1i', '5AD1iP', '5BBA', '5BBC', '5BBDA', '5BBF', '5BBG',
	            			'5Ea', '1', 'Others' ];
...
function calculateSchDPM() {
		...
		dpmCeasesMesg='';
		var rate15Adjustment = coalesceSetRet("scheduleDPM.plantMachinery.rate15.depreciationDetail.wdvFirstDay") + coalesceSetRet("scheduleDPM.plantMachinery.rate15.depreciationDetail.wdvFirstDayN")+ coalesceSetRet("scheduleDPM.plantMachinery.rate15.depreciationDetail.additionsGrThan180Days") - coalesceSetRet("scheduleDPM.plantMachinery.rate15.depreciationDetail.realizationTotalPeriod");
		var rate30Adjustment = coalesceSetRet("scheduleDPM.plantMachinery.rate30.depreciationDetail.wdvFirstDay") + coalesceSetRet("scheduleDPM.plantMachinery.rate30.depreciationDetail.wdvFirstDayN") + coalesceSetRet("scheduleDPM.plantMachinery.rate30.depreciationDetail.additionsGrThan180Days") - coalesceSetRet("scheduleDPM.plantMachinery.rate30.depreciationDetail.realizationTotalPeriod");
		var rate40Adjustment = coalesceSetRet("scheduleDPM.plantMachinery.rate40.depreciationDetail.wdvFirstDay") + coalesceSetRet("scheduleDPM.plantMachinery.rate40.depreciationDetail.wdvFirstDayN") + coalesceSetRet("scheduleDPM.plantMachinery.rate40.depreciationDetail.additionsGrThan180Days") - coalesceSetRet("scheduleDPM.plantMachinery.rate40.depreciationDetail.realizationTotalPeriod");
		...
		document.getElementsByName("scheduleDPM.plantMachinery.rate15.depreciationDetail.netAgvDepreciation")[0].value = eval
		(coalesceSetRet("scheduleDPM.plantMachinery.rate15.depreciationDetail.totalDepreciation") -
		coalesceSetRet("scheduleDPM.plantMachinery.rate15.depreciationDetail.depreciationITAct"));



		document.getElementsByName("scheduleDPM.plantMachinery.rate30.depreciationDetail.netAgvDepreciation")[0].value = eval
		(coalesceSetRet("scheduleDPM.plantMachinery.rate30.depreciationDetail.totalDepreciation") -
		coalesceSetRet("scheduleDPM.plantMachinery.rate30.depreciationDetail.depreciationITAct"));


		document.getElementsByName("scheduleDPM.plantMachinery.rate40.depreciationDetail.netAgvDepreciation")[0].value = eval
		(coalesceSetRet("scheduleDPM.plantMachinery.rate40.depreciationDetail.totalDepreciation") -
		coalesceSetRet("scheduleDPM.plantMachinery.rate40.depreciationDetail.depreciationITAct"));
...
function calculateSchDOA() {
	...
	document.getElementsByName("scheduleDOA.building.rate100.depreciationDetail.depreciationAtFullRate")[0].value = Math.round(coalesceSetRet("scheduleDOA.building.rate100.depreciationDetail.fullRateDeprAmt")*0.4);
	...
	document.getElementsByName("scheduleDOA.building.rate100.depreciationDetail.depreciationAtHalfRate")[0].value = Math.round(coalesceSetRet("scheduleDOA.building.rate100.depreciationDetail.halfRateDeprAmt") * 0.2);
    ...
    document.getElementsByName("scheduleDOA.building.rate5.depreciationDetail.depreciationNetAgg")[0].value = zeroOrMore(coalesceSetRet("scheduleDOA.building.rate5.depreciationDetail.totalDepreciation") - coalesceSetRet("scheduleDOA.building.rate5.depreciationDetail.depreciationAtSec38"));
	document.getElementsByName("scheduleDOA.building.rate10.depreciationDetail.depreciationNetAgg")[0].value = zeroOrMore(coalesceSetRet("scheduleDOA.building.rate10.depreciationDetail.totalDepreciation") - coalesceSetRet("scheduleDOA.building.rate10.depreciationDetail.depreciationAtSec38"));
	document.getElementsByName("scheduleDOA.building.rate100.depreciationDetail.depreciationNetAgg")[0].value = zeroOrMore(coalesceSetRet("scheduleDOA.building.rate100.depreciationDetail.totalDepreciation") - coalesceSetRet("scheduleDOA.building.rate100.depreciationDetail.depreciationAtSec38"));
	document.getElementsByName("scheduleDOA.furnitureFittings.rate10.depreciationDetail.depreciationNetAgg")[0].value = zeroOrMore(coalesceSetRet("scheduleDOA.furnitureFittings.rate10.depreciationDetail.totalDepreciation") - coalesceSetRet("scheduleDOA.furnitureFittings.rate10.depreciationDetail.depreciationAtSec38"));
	document.getElementsByName("scheduleDOA.intangibleAssets.rate25.depreciationDetail.depreciationNetAgg")[0].value = zeroOrMore(coalesceSetRet("scheduleDOA.intangibleAssets.rate25.depreciationDetail.totalDepreciation") - coalesceSetRet("scheduleDOA.intangibleAssets.rate25.depreciationDetail.depreciationAtSec38"));
	document.getElementsByName("scheduleDOA.ships.rate20.depreciationDetail.depreciationNetAgg")[0].value = zeroOrMore(coalesceSetRet("scheduleDOA.ships.rate20.depreciationDetail.totalDepreciation") - coalesceSetRet("scheduleDOA.ships.rate20.depreciationDetail.depreciationAtSec38"));

	if(parseInt(	document.getElementsByName("scheduleDOA.building.rate5.depreciationDetail.propDepreciationNetAgg")[0].value )>
	parseInt(document.getElementsByName("scheduleDOA.building.rate5.depreciationDetail.depreciationNetAgg")[0].value)){
		j.setFieldError('scheduleDOA.building.rate5.depreciationDetail.propDepreciationNetAgg','Amount cannot be more than the amount entered in Net aggregate depreciation ');
		addErrorXHTML( document.getElementsByName('scheduleDOA.building.rate5.depreciationDetail.propDepreciationNetAgg')[0],
				'Amount cannot be more than the amount entered in Net aggregate depreciation ',
				true);
	}

	if(	parseInt(document.getElementsByName("scheduleDOA.building.rate10.depreciationDetail.propDepreciationNetAgg")[0].value) >
	parseInt(document.getElementsByName("scheduleDOA.building.rate10.depreciationDetail.depreciationNetAgg")[0].value)){

		j.setFieldError('scheduleDOA.building.rate10.depreciationDetail.propDepreciationNetAgg','Amount cannot be more than the amount entered in Net aggregate depreciation ');
		addErrorXHTML( document.getElementsByName('scheduleDOA.building.rate10.depreciationDetail.propDepreciationNetAgg')[0],
				'Amount cannot be more than the amount entered in Net aggregate depreciation ',
				true);

	}

	if(	parseInt(document.getElementsByName("scheduleDOA.building.rate100.depreciationDetail.propDepreciationNetAgg")[0].value) >
	parseInt(document.getElementsByName("scheduleDOA.building.rate100.depreciationDetail.depreciationNetAgg")[0].value)){
		j.setFieldError('scheduleDOA.building.rate100.depreciationDetail.propDepreciationNetAgg','Amount cannot be more than the amount entered in Net aggregate depreciation ');
		addErrorXHTML( document.getElementsByName('scheduleDOA.building.rate100.depreciationDetail.propDepreciationNetAgg')[0],
				'Amount cannot be more than the amount entered in Net aggregate depreciation ',
				true);
	}
	if(parseInt(	document.getElementsByName("scheduleDOA.furnitureFittings.rate10.depreciationDetail.propDepreciationNetAgg")[0].value )>
	parseInt(document.getElementsByName("scheduleDOA.furnitureFittings.rate10.depreciationDetail.depreciationNetAgg")[0].value)){
		j.setFieldError('scheduleDOA.furnitureFittings.rate10.depreciationDetail.propDepreciationNetAgg','Amount cannot be more than the amount entered in Net aggregate depreciation ');
		addErrorXHTML( document.getElementsByName('scheduleDOA.furnitureFittings.rate10.depreciationDetail.propDepreciationNetAgg')[0],
				'Amount cannot be more than the amount entered in Net aggregate depreciation ',
				true);
	}

	if(	parseInt(document.getElementsByName("scheduleDOA.intangibleAssets.rate25.depreciationDetail.propDepreciationNetAgg")[0].value) >
	parseInt(document.getElementsByName("scheduleDOA.intangibleAssets.rate25.depreciationDetail.depreciationNetAgg")[0].value)){
		j.setFieldError('scheduleDOA.intangibleAssets.rate25.depreciationDetail.propDepreciationNetAgg','Amount cannot be more than the amount entered in Net aggregate depreciation ');
		addErrorXHTML( document.getElementsByName('scheduleDOA.intangibleAssets.rate25.depreciationDetail.propDepreciationNetAgg')[0],
				'Amount cannot be more than the amount entered in Net aggregate depreciation ',
				true);
	}
	...
	if(	parseInt(document.getElementsByName("scheduleDOA.ships.rate20.depreciationDetail.propDepreciationNetAgg")[0].value) >
	parseInt(document.getElementsByName("scheduleDOA.ships.rate20.depreciationDetail.depreciationNetAgg")[0].value)){
		j.setFieldError('scheduleDOA.ships.rate20.depreciationDetail.propDepreciationNetAgg','Amount cannot be more than the amount entered in Net aggregate depreciation ');
		addErrorXHTML( document.getElementsByName('scheduleDOA.ships.rate20.depreciationDetail.propDepreciationNetAgg')[0],
				'Amount cannot be more than the amount entered in Net aggregate depreciation ',
				true);
	}
...
//for field 18
	...
	document
			.getElementsByName("scheduleDOA.building.rate100.depreciationDetail.wdvLastDay")[0].value = zeroOrMore(coalesceSetRet("scheduleDOA.building.rate100.depreciationDetail.fullRateDeprAmt")
			+ coalesceSetRet("scheduleDOA.building.rate100.depreciationDetail.halfRateDeprAmt")
			- coalesceSetRet("scheduleDOA.building.rate100.depreciationDetail.totalDepreciation") + parseInt(buildingRate100FullRateDeprAmt,10));
	...
	document.getElementsByName("scheduleDOA.building.rateNil.depreciationDetail.wdvLastDay")[0].value =
		zeroOrMore(coalesceSetRet("scheduleDOA.building.rateNil.depreciationDetail.wdvFirstDay") );
...
/*	var deprBlockTot50Percent = document.getElementsByName('scheduleDEP.summaryFromDeprSch.plantMachinerySummary.deprBlockTot50Percent')[0]; deprBlockTot50Percent.value = coalesce(deprBlockTot50Percent.value);
	...
	if(coalesce( parseInt(document.getElementsByName('scheduleDPM.plantMachinery.rate15.depreciationDetail.propAvgDepreciation')[0].value,10) ) >0){

		deprBlockTot15Percent.value =coalesce(document.getElementsByName('scheduleDPM.plantMachinery.rate15.depreciationDetail.propAvgDepreciation')[0].value)
	}else{
		deprBlockTot15Percent.value =coalesce(document.getElementsByName('scheduleDPM.plantMachinery.rate15.depreciationDetail.netAgvDepreciation')[0].value)
	}
	...
	if(coalesce( parseInt(document.getElementsByName('scheduleDPM.plantMachinery.rate30.depreciationDetail.propAvgDepreciation')[0].value,10) ) >0){
			deprBlockTot30Percent.value = coalesce(document.getElementsByName('scheduleDPM.plantMachinery.rate30.depreciationDetail.propAvgDepreciation')[0].value) ;
		}
	    else
	    {
			deprBlockTot30Percent.value = coalesce(document.getElementsByName('scheduleDPM.plantMachinery.rate30.depreciationDetail.netAgvDepreciation')[0].value) ;
		}
    ...
    if(coalesce( parseInt(document.getElementsByName('scheduleDPM.plantMachinery.rate40.depreciationDetail.propAvgDepreciation')[0].value,10) ) >0)
    {
	deprBlockTot40Percent.value = coalesce(document.getElementsByName('scheduleDPM.plantMachinery.rate40.depreciationDetail.propAvgDepreciation')[0].value) ;
	}
    else
    {
	deprBlockTot40Percent.value = coalesce(document.getElementsByName('scheduleDPM.plantMachinery.rate40.depreciationDetail.netAgvDepreciation')[0].value) ;
	}
	...
	/*+ eval(parseInt(deprBlockTot50Percent.value,10)) + eval(parseInt(deprBlockTot60Percent.value,10)) + eval(parseInt(deprBlockTot80Percent.value,10))
	+ eval(parseInt(deprBlockTot100Percent.value,10))*/;


    if(coalesce( parseInt(document.getElementsByName('scheduleDOA.building.rate5.depreciationDetail.propDepreciationNetAgg')[0].value,10) ) >0)
    {
	 	deprBlockTot5Percent.value = coalesce(document.getElementsByName('scheduleDOA.building.rate5.depreciationDetail.propDepreciationNetAgg')[0].value) ;

	}
    else
    {

		deprBlockTot5Percent.value = coalesce(document.getElementsByName('scheduleDOA.building.rate5.depreciationDetail.depreciationNetAgg')[0].value) ;
	}
    ...
    if(coalesce( parseInt(document.getElementsByName('scheduleDOA.building.rate10.depreciationDetail.propDepreciationNetAgg')[0].value,10) ) >0)
    {
	 	deprBlockTot10Percent.value = coalesce(document.getElementsByName('scheduleDOA.building.rate10.depreciationDetail.propDepreciationNetAgg')[0].value) ;
	}
    else
    {
		deprBlockTot10Percent.value = coalesce(document.getElementsByName('scheduleDOA.building.rate10.depreciationDetail.depreciationNetAgg')[0].value) ;
	}
    ...
    if(coalesce( parseInt(document.getElementsByName('scheduleDOA.building.rate100.depreciationDetail.propDepreciationNetAgg')[0].value,10) ) >0)
    {
	 buildingDeprBlockTot100Percent.value = coalesce(document.getElementsByName('scheduleDOA.building.rate100.depreciationDetail.propDepreciationNetAgg')[0].value) ;
	}
    else
    {
    buildingDeprBlockTot100Percent.value = coalesce(document.getElementsByName('scheduleDOA.building.rate100.depreciationDetail.depreciationNetAgg')[0].value) ;
	}
	...
	//furnitureSummary.value = coalesce(document.getElementsByName('scheduleDOA.furnitureFittings.rate10.depreciationDetail.totalDepreciation')[0].value) ;
	if(parseInt(document.getElementsByName('scheduleDOA.furnitureFittings.rate10.depreciationDetail.propDepreciationNetAgg')[0].value,10)>0){
		furnitureSummary.value = coalesce(document.getElementsByName('scheduleDOA.furnitureFittings.rate10.depreciationDetail.propDepreciationNetAgg')[0].value);
	}
	else{
		furnitureSummary.value = coalesce(document.getElementsByName('scheduleDOA.furnitureFittings.rate10.depreciationDetail.depreciationNetAgg')[0].value);
	}
	...
	if(parseInt(document.getElementsByName('scheduleDOA.intangibleAssets.rate25.depreciationDetail.propDepreciationNetAgg')[0].value,10)>0){
		intangibleAssetSummary.value = coalesce(document.getElementsByName('scheduleDOA.intangibleAssets.rate25.depreciationDetail.propDepreciationNetAgg')[0].value);
	}
	else{
		intangibleAssetSummary.value = coalesce(document.getElementsByName('scheduleDOA.intangibleAssets.rate25.depreciationDetail.depreciationNetAgg')[0].value);
	}
	
	if(parseInt(document.getElementsByName('scheduleDOA.ships.rate20.depreciationDetail.propDepreciationNetAgg')[0].value,10)>0){
		shipsSummary.value = coalesce(document.getElementsByName('scheduleDOA.ships.rate20.depreciationDetail.propDepreciationNetAgg')[0].value);
	}
	else{
		shipsSummary.value = coalesce(document.getElementsByName('scheduleDOA.ships.rate20.depreciationDetail.depreciationNetAgg')[0].value);
	}
...
function calculatePointNo16DPM(percentRate) {
	 if( $('[name="scheduleDPM.plantMachinery.'+percentRate+'.depreciationDetail.capGainUs50"]')[0].value!=0 &&  $('[name="scheduleDPM.plantMachinery.'+percentRate+'.depreciationDetail.capGainUs50"]')[0].value!="") {
    	 ...
    	 $('[name="scheduleDPM.plantMachinery.'+percentRate+'.depreciationDetail.netAgvDepreciation"]')[0].value=0;
    	 $('[name="scheduleDPM.plantMachinery.'+percentRate+'.depreciationDetail.depreciationITAct"]')[0].value=0;
    	 $('[name="scheduleDPM.plantMachinery.'+percentRate+'.depreciationDetail.propAvgDepreciation"]')[0].value=0;
...
function calcPoint16DPMvalue(percentRate) {
	return coalesceSetRet("scheduleDPM.plantMachinery."+percentRate+".depreciationDetail.realizationTotalPeriod") + coalesceSetRet("scheduleDPM.plantMachinery."+percentRate+".depreciationDetail.realizationPeriodDuringYear") - coalesceSetRet("scheduleDPM.plantMachinery."+percentRate+".depreciationDetail.wdvFirstDay") -
	coalesceSetRet("scheduleDPM.plantMachinery."+percentRate+".depreciationDetail.wdvFirstDayN") -
	coalesceSetRet("scheduleDPM.plantMachinery."+percentRate+".depreciationDetail.additionsGrThan180Days") - coalesceSetRet("scheduleDPM.plantMachinery."+percentRate+".depreciationDetail.additionsLessThan180Days") - coalesceSetRet("scheduleDPM.plantMachinery."+percentRate+".depreciationDetail.expdrOnTrforSaleAsset");
}
...
function calculatePointNo16DOA(assetName,percentRate) {
	 if( $('[name="scheduleDOA.'+assetName+'.'+percentRate+'.depreciationDetail.capGainUs50"]')[0].value!=0 &&  $('[name="scheduleDOA.'+assetName+'.'+percentRate+'.depreciationDetail.capGainUs50"]')[0].value!="") {
		...
		$('[name="scheduleDOA.'+assetName+'.'+percentRate+'.depreciationDetail.depreciationNetAgg"]')[0].value=0;
		$('[name="scheduleDOA.'+assetName+'.'+percentRate+'.depreciationDetail.propDepreciationNetAgg"]')[0].value=0;
		$('[name="scheduleDOA.'+assetName+'.'+percentRate+'.depreciationDetail.depreciationAtSec38"]')[0].value=0;
...
function calcSchCG(cgosIncome){
	try{
		...
		var totScheduleCGPost45 =
		document.getElementsByName('scheduleCGPost45.totScheduleCGPost45')[0];
...
function validateOnSubmit() {
	...
	//	check54GBPan();
		...
		panValidationTDS2('scheduleTDS2');
		panValidationTDS2('scheduleTDS3');
		threeFieldsValidationforTDS2OnSave();
		threeFieldsValidationforTDS3OnSave();

		calcTotFullConA('scheduleCGPost45.shortTermCapGainPost45.nRISecur115AD.fullConsidtnia',
				'scheduleCGPost45.shortTermCapGainPost45.nRISecur115AD.fullConsidtnib',
				'scheduleCGPost45.shortTermCapGainPost45.nRISecur115AD.fullConsidtnic');

		calcTotFullConA('scheduleCGPost45.shortTermCapGainPost45.saleOnOtherAssets.fullConsidtnia',
				'scheduleCGPost45.shortTermCapGainPost45.saleOnOtherAssets.fullConsidtnib',
				'scheduleCGPost45.shortTermCapGainPost45.saleOnOtherAssets.fullConsidtnic');

		calcTotFullConA('scheduleCGPost45.longTermCapGainPost45.saleofAssetNA.deductSec48.fullConsidtnia',
				'scheduleCGPost45.longTermCapGainPost45.saleofAssetNA.deductSec48.fullConsidtnib',
				'scheduleCGPost45.longTermCapGainPost45.saleofAssetNA.deductSec48.fullConsidtnic');

		calcTotFullConTable();
		//validateGST();


		validateSchCGSTCGAmt();
		validateSchCGLTCGAmt();
		checkFor16thFiledValue();
		checkFor18thFiledValue();
		checkFor15thFiledValue();
		onBPTableWithSingleDropMand();
		validateDedUs54();
		validateDedUs54B();
		validateDedUs54D();
		validateDedUs54F();
...
function calculateOS(cgosIncome){
	...
	totalOSGrossChargblSplRate.value = eval(
			...
			+ parseInt(coalesceSetRet('scheduleOS.incChargblSplRateOS.115BBG'),10)
...
function calculateOSGross(simap){
	...
	var v115BBDAsec = document
	.getElementsByName('scheduleOS.incChargblSplRateOS.115BBDA')[0];
	v115BBDAsec.value = parseInt(0,10);

	var v115BBFsec = document
	.getElementsByName('scheduleOS.incChargblSplRateOS.115BBF')[0];
	v115BBFsec.value = parseInt(0,10);

	var v115BBEsec = document
	.getElementsByName('scheduleOS.incChargblSplRateOS.115BBE')[0];
	v115BBEsec.value =parseInt(0,10);

	var v115BBGsec = document
	.getElementsByName('scheduleOS.incChargblSplRateOS.115BBG')[0];
	v115BBGsec.value = parseInt(0,10);
	...
	document.getElementsByName('scheduleOS.incChargblSplRateOS.115BBDA')[0].value = finalBBDA;

	var finalBBF = parseInt(0,10);
	finalBBF = zeroOrMore( v115BBFsec.value - dropDownBBF);
	document.getElementsByName('scheduleOS.incChargblSplRateOS.115BBF')[0].value = finalBBF;

	var finalBBE = parseInt(0,10);
	finalBBE = zeroOrMore(v115BBEsec.value - dropDownBBE);
	document.getElementsByName('scheduleOS.incChargblSplRateOS.115BBE')[0].value = finalBBE;

	var finalBBG = parseInt(0,10);
	finalBBG = zeroOrMore(v115BBGsec.value - dropDownBBG);
	document.getElementsByName('scheduleOS.incChargblSplRateOS.115BBG')[0].value = finalBBG;
	...
	var temp115BBG = document.getElementsByName('scheduleOS.incChargblSplRateOS.115BBG')[0].value;
...
function calcTotSchEIOthers(){
	var amtTotal = parseInt('0' ,10);
	var tabl = document.getElementById('scheduleEI1');
	var allInputTags = tabl.getElementsByTagName('input');

	for(var i = 0; i < allInputTags.length; i++) {
		if (allInputTags[i].name.match("othAmount$")) {
			amtTotal = eval(parseInt(amtTotal ,10) + parseInt(isNVL(allInputTags[i].value) ,10));
		}
	}

	document.getElementsByName('scheduleEI.others')[0].value = amtTotal;
}
...
try{
	...
	document.getElementsByName('partBTI.profBusGain.totProfBusGain')[0].value = eval(
		...
		+parseInt(coalesceSetRet('partBTI.profBusGain.profIncome115BBG'),10)
		);
...
var shortTermSplRateDTAA = document
.getElementsByName('partBTI.capGain.shortTerm.shortTermSplRateDTAA')[0];
shortTermSplRateDTAA.value = coalesceSetRet('scheduleCGPost45.shortTermCapGainPost45.stcgUnderDtaa.AmtStcgUnderDtaa8b');
...
var longTermSplRateDTAA = document
.getElementsByName('partBTI.capGain.longTerm.longTermDTAAPer')[0];
longTermSplRateDTAA.value = coalesceSetRet('scheduleCGPost45.longTermCapGainPost45.ltcgUnderDtaa.AmtLtcgUnderDtaa10b');
...
//4a	scheduleCGFor23.shortTermCapGainFor23.nriAssetSec48Dtl.nri111AApplicable
	...
	totalShortTerm.value = eval(parseInt(shortTerm15Per.value, 10)
			 ...
			 + parseInt(shortTermSplRateDTAA.value, 10)
			 );
//43b
	...
	totalLongTerm.value = eval(parseInt(longTerm10Per.value, 10)
			 ...
			 + parseInt(longTermSplRateDTAA.value, 10)
			);
...
function calculateTaxPayableOnTotalInc(srcElementName, destElementName, forRebate){
	...
	if((pan.substring(3,4)=='P' || pan.substring(3,4)=='p') && taxPayer.value=='I' && age > 59 && age < 80 && (resStatus.value=='RES' || resStatus.value=='NOR')){
		...
		if(parseInt(netTxblIncome,10) >= parseInt('0',10) && parseInt(netTxblIncome,10) <= parseInt('300000',10)){
			...
			tax = Math.round(eval( eval(parseInt(netTxblIncome,10) - parseInt('300000',10) )  * parseFloat('0.05'))) ;
		}else if(parseInt(netTxblIncome,10) >= parseInt('500001',10) && parseInt(netTxblIncome,10) <= parseInt('1000000',10)){
			tax = Math.round(eval(eval(eval(parseInt(netTxblIncome,10) - parseInt('500000',10) )* parseFloat('0.2')) + parseInt('10000',10)));
		}else if(parseInt(netTxblIncome,10) >= parseInt('1000001',10)){
			tax = Math.round(eval(eval(eval(parseInt(netTxblIncome,10) - parseInt('1000000',10) )* parseFloat('0.3')) + parseInt('110000',10)));
		}
		...
		if(parseInt(netTxblIncome,10) >= parseInt('0',10) && parseInt(netTxblIncome,10) <= parseInt('250000',10)){
			...
			tax = Math.round(eval( eval(parseInt(netTxblIncome,10) - parseInt('250000',10) )  * parseFloat('0.05'))) ;
		}else if(parseInt(netTxblIncome,10) >= parseInt('500001',10) && parseInt(netTxblIncome,10) <= parseInt('1000000',10)){
			tax = Math.round(eval(eval(eval(parseInt(netTxblIncome,10) - parseInt('500000',10) )* parseFloat('0.2')) + parseInt('12500',10)));
		}else if(parseInt(netTxblIncome,10) >= parseInt('1000001',10)){
			tax = Math.round(eval(eval(eval(parseInt(netTxblIncome,10) - parseInt('1000000',10) )* parseFloat('0.3')) + parseInt('112500',10)));
		}
...
function calsurchargeOnAmtcAboveCrore(){
	...
	// for surcharge
				...
				else if( (rndOffNrsTen(totInc.value) > 5000000 && rndOffNrsTen(totInc.value) <= 10000000)){
...
function calculatePartBTTI_first(cgosIncome){
	...
	var falg115H = document.getElementsByName('partAGEN1.filingStatus.benefitUs115HFlg')[0].value;
		...
		if(status=='I' && (resStatus=='RES' || resStatus=='NOR') && totalIncome<=350000){
			rebate87A.value = Math.min(parseInt(taxPayable,10),2500);
		} else {
...
function calsurchargeOnAboveCrore(cgosIncome){
	...
	// for surcharge
				...
				if( rndOffNrsTen(totInc) > 10000000 ){
					...
					var surofTaxon1cr = taxbefore60per * 0.10;   //surcharge on 1 Cr tax


					if( (taxOnTotInc + tempSurcharge ) > (taxOnCutOffInc + extraInc + surofTaxon1cr)){


						var marginalRelief = zeroOrMore(taxOnTotInc + tempSurcharge - (taxOnCutOffInc + extraInc + surofTaxon1cr));
				...
				else if( (rndOffNrsTen(totInc) > 5000000) && (rndOffNrsTen(totInc) < 10000001)){
					var f_115BBE = eval(parseInt(
							coalesceSetRet('partBTTI.computationOfTaxLiability.taxPayableOnTI.taxPayable'),10)- (parseInt(coalesceSetRet('scheduleOS.incChargblSplRateOS.115BBE'),10) * 0.60));
					var tempSurcharge = eval((0.10 * parseInt(f_115BBE, 10))+ (parseInt(coalesceSetRet('scheduleOS.incChargblSplRateOS.115BBE'),10) * 0.60 * 0.25));
...
function getDueDate234A(){
	...
	if(auditFlag92E == 'Y'){
		duedate234A = '30/11/2018';
	}else if(auditFlag=='Y'){
		duedate234A = "30/09/2018";
	}else {
...
function calcInterestPayable(cgosIncome){
	...
	try{
			...
			}else if(dueDate234A == '30/09/2018'){
				dueDate234A = '01/10/2018';

			}else if(dueDate234A == '30/11/2018'){
				dueDate234A = '01/12/2018';
			}
	     ...
	     // ===============Interest234F calculation=======================
			...
			.getElementsByName('partAGEN1.filingStatus.residentialStatus')[0].value;
	        var filingSec = document
			.getElementsByName('partAGEN1.filingStatus.returnFileSec')[0].value;

			var totInc = parseInt(document.getElementsByName('partBTI.totalIncome')[0].value);
			var gti_234FMain = parseInt(document.getElementsByName('partBTI.grossTotalIncome')[0].value);
			var dob_234F= document.getElementsByName('partAGEN1.personalInfo.dob')[0].value;
			var taxPayer = document.getElementsByName('partAGEN1.personalInfo.status')[0].value;
			var schEIVal= parseInt(document.getElementsByName('scheduleEI.ltcgWhereSTTPaid')[0].value);
			
			var gti_234F = eval(parseInt(gti_234FMain,10) + parseInt(schEIVal,10));

			var d_date = getDueDate234A();

			if(d_date == Filing_dueDate){

				d_date = Int_start_date_234A;
			...
			/*var revised44AB = document.getElementsByName('partAGEN2.auditInfo.liableSec44ABflg')[0].value;
			var revised92E=document.getElementsByName('partAGEN2.liableSec92Eflg')[0].value;

			var d_date;

			if ( revised44AB == 'Y' && revised92E== 'N' ){
				d_date = '01/10/2018';
			}
			else if( revised44AB == 'N' && revised92E== 'Y' ){
				d_date = '01/12/2018';
			}
			else if( revised44AB == 'Y' && revised92E== 'Y' ){
				d_date = '01/12/2018';
			}
			else{
				d_date = '01/08/2018';
			...
			if(taxPayer == 'I' && (resStatus == 'RES' || resStatus == 'NOR'))
				{
					if (filingType == '17' || filingType == '18') {


				if (checkFirstDateBefore(dob_234F, '01/04/1938')) {
					if (gti_234F > '500000') {
						if (totInc <= '500000') {
							if (checkFirstDateBefore(d_date,
									originalFilingDate)) {
								intrst234F = '1000';
							} else {
								intrst234F = '0';
							...
							if (checkFirstDateBefore(d_date,
									originalFilingDate)
									&& checkFirstDateBefore(originalFilingDate,
											'31/12/2018')) {
								intrst234F = '5000';
							} else if (checkFirstDateBefore('01/01/2019',
									originalFilingDate)) {
								intrst234F = '10000';
							} else {
								intrst234F = '0';
				...
				} else if ((checkFirstDateBefore('02/04/1938', dob_234F))
						&& (checkFirstDateBefore(dob_234F, '01/04/1958'))) {
					alert('between 1938-1958');
					if (gti_234F > '300000') {
						if (totInc <= '500000') {
							if (checkFirstDateBefore(d_date,
									originalFilingDate)) {
							...
							if (checkFirstDateBefore(d_date,
									...
									&& checkFirstDateBefore(originalFilingDate,
											'31/12/2018')) {
								alert("inside the wrong loop");
								intrst234F = '5000';
							} else if (checkFirstDateBefore('01/01/2019',
									originalFilingDate)) {
								alert("inside the right loop");
								intrst234F = '10000';
							} else {
								intrst234F = '0';
							}
					...
					if (gti_234F > '250000') {
						// alert('totInc'+totInc);
						if (totInc <= '500000') {
							// alert('after 1958 and income <=5L');
							if (checkFirstDateBefore(d_date,
									originalFilingDate)) {
								// alert('filed after due date');
								intrst234F = '1000';
							} else {
								intrst234F = '0';
							}
							...
							// alert('after 1958 and income >5L');
							// alert('originalFilingDate222222'+originalFilingDate);
							if (checkFirstDateBefore(d_date,
									originalFilingDate)
									&& checkFirstDateBefore(originalFilingDate,
											'31/12/2018')) {
								// alert('after 1958 and income >5L before 31st
								// dec');
								intrst234F = '5000';
							} else if (checkFirstDateBefore('01/01/2019',
									originalFilingDate)) {
								// alert('after 1958 and income >5L after 31st
								// dec');
								intrst234F = '10000';
							} else {
								intrst234F = '0';
				...
				alert('gti_234F:: '+gti_234F);
				alert('totInc:: '+totInc);

				if (checkFirstDateBefore(dob_234F, '01/04/1938')) {
					if (gti_234F > '500000') {
						if (totInc <= '500000') {
							if (checkFirstDateBefore(d_date, currentDate)) {
								intrst234F = '1000';
							} else {
								intrst234F = '0';
							}
						}
						// else if(totInc >'500000'){
						else {
							//alert('insideeeeeeeeee else');
							if (checkFirstDateBefore(d_date, currentDate)
									&& checkFirstDateBefore(currentDate,
											'31/12/2018')) {
								intrst234F = '5000';
							} else if (checkFirstDateBefore('01/01/2019',
									currentDate)) {
						...
						if (totInc <= '500000') {
							...
							if (checkFirstDateBefore(d_date, currentDate)
									&& checkFirstDateBefore(currentDate,
											'31/12/2018')) {
								intrst234F = '5000';
								alert('should be this::: '+ intrst234F);
							} else if (checkFirstDateBefore('01/01/2019',
									currentDate)) {
								intrst234F = '10000';
								alert('ot this::: '+ intrst234F);
							} else {
								intrst234F = '0';
							}
					...
					if (gti_234F > '250000') {
						...
						if (totInc <= '500000') {
							...
							if (checkFirstDateBefore(d_date, currentDate)
									&& checkFirstDateBefore(currentDate,
											'31/12/2018')) {
								 alert('after 1958 and income >5L before 31st dec');
								intrst234F = '5000';
							} else if (checkFirstDateBefore('01/01/2019',
									currentDate)) {
								alert('after 1958 and income >5L after 31st dec');
								intrst234F = '10000';
							} else {
								intrst234F = '0';
							}
				...
				if (filingType == '17' || filingType == '18') {
					// alert('originalFilingDate'+originalFilingDate);
					alert('sec 17');
					if (checkFirstDateBefore(dob_234F, '01/04/1938')) {
						// alert('before 1938');
						//alert("gti_234Fgti_234F:::"+gti_234F);
						if (gti_234F > '500000') {
							if (totInc <= '500000') {
								if (checkFirstDateBefore(d_date,
										originalFilingDate)) {
				...
				// alert('gti_234Fgti_234Fgti_234F:::'+gti_234F);
				if (gti_234F > '250000') {
...
function calculate234cIntrst(TDS, TCS, slabs, cgosIncome){
		...
		var normalBalIncome = eval(
							...
							- parseInt(coalesceSetRet('itr4ScheduleBP.businessIncOthThanSpec.incRecCredPLOthHeads.us115BBG'))
							- parseInt(coalesceSetRet('partBTI.capGain.shortTerm.shortTermSplRateDTAA'))  - parseInt(coalesceSetRet('partBTI.capGain.longTerm.longTermDTAAPer'))
							- parseInt(coalesceSetRet('partBTI.totalDeductionsUnderScheduleVIA')) - parseInt(coalesceSetRet('partBTI.deductionsUnder10Aor10AA'))
							);
...
/*
function OSSubCalInc() {

	document
			.getElementsByName('scheduleOS.incOthThanOwnRaceHorse.othersGrossDtls[13].sourceAmount')[0].value =
			eval( parseInt(
			coalesceSetRet('scheduleOS.incOthThanOwnRaceHorse.othersGrossDtls[8].sourceAmount'),
			10)
			+ parseInt(
					coalesceSetRet('scheduleOS.incOthThanOwnRaceHorse.othersGrossDtls[9].sourceAmount'),
					10)
			+ parseInt(
					coalesceSetRet('scheduleOS.incOthThanOwnRaceHorse.othersGrossDtls[10].sourceAmount'),
					10)
			+ parseInt(
					coalesceSetRet('scheduleOS.incOthThanOwnRaceHorse.othersGrossDtls[11].sourceAmount'),
					10)
			+ parseInt(
					coalesceSetRet('scheduleOS.incOthThanOwnRaceHorse.othersGrossDtls[12].sourceAmount'),
					10) );
...
function calculateSlabbedTax(netTxblIncome, dontAddExemption){
	...
	if( status == 'I' && (resStatus=='RES' || resStatus =='NOR') && parseInt(age, 10) > 59 && parseInt(age, 10) < 80 ){
		if(parseInt(netTxblIncome,10) >= parseInt('0',10) && parseInt(netTxblIncome,10) <= parseInt('300000',10)){
			...
			incTax = Math.round(eval( eval(parseInt(netTxblIncome,10) - parseInt('300000',10) )  * parseFloat('0.05'))) ;
		}else if(parseInt(netTxblIncome,10) >= parseInt('500001',10) && parseInt(netTxblIncome,10) <= parseInt('1000000',10)){
			incTax = Math.round(eval(eval(eval(parseInt(netTxblIncome,10) - parseInt('500000',10) )* parseFloat('0.2')) + parseInt('10000',10)));
		}else if(parseInt(netTxblIncome,10) >= parseInt('1000001',10)){
			incTax = Math.round(eval(eval(eval(parseInt(netTxblIncome,10) - parseInt('1000000',10) )* parseFloat('0.3')) + parseInt('110000',10)));
		}
	}
		...
		if(parseInt(netTxblIncome,10) >= parseInt('0',10) && parseInt(netTxblIncome,10) <= parseInt('250000',10)){
			...
			incTax = Math.round(eval( eval(parseInt(netTxblIncome,10) - parseInt('250000',10) )  * parseFloat('0.05'))) ;
		}else if(parseInt(netTxblIncome,10) >= parseInt('500001',10) && parseInt(netTxblIncome,10) <= parseInt('1000000',10)){
			incTax = Math.round(eval(eval(eval(parseInt(netTxblIncome,10) - parseInt('500000',10) )* parseFloat('0.2')) + parseInt('12500',10)));
		}else if(parseInt(netTxblIncome,10) >= parseInt('1000001',10)){
			incTax = Math.round(eval(eval(eval(parseInt(netTxblIncome,10) - parseInt('1000000',10) )* parseFloat('0.3')) + parseInt('112500',10)));
		}
	}
	return incTax;
}
	...
	try{
		...
		*/
		...
		if(setOffRem>=0){
			...
			if( !checkIfChanged('scheduleCYLA.Salaries.incCYLA.hPlossCurYrSetoff')){
				document.getElementsByName('scheduleCYLA.Salaries.incCYLA.hPlossCurYrSetoff')[0].value = prevSetOffRem;
					//coalescePath('scheduleCYLA.totalCurYr.totHPlossCurYr');
			}else {
				checkHPeditableValidity('scheduleCYLA.Salaries.incCYLA.hPlossCurYrSetoff',
						'scheduleCYLA.Salaries.incCYLA.incOfCurYrUnderThatHead','scheduleCYLA.Salaries.incCYLA.othSrcLossNoRaceHorseSetoff'
		...
		if(setOffRem>=0){
			if(prevSetOffRem==0){
				...
				/*alert('setOffLossVal::'+setOffLossVal);
				alert('hpLossRem::'+hpLossRem);*/
...
function calcCFL(specltvIncSetOff, specfdIncSetOff){
	...
	/*	document.getElementsByName('scheduleCFL.currentAYloss.lossSummaryDetail.hpLossCF')[0].value =
		...
		setEditableFieldValue(hpLossCFL,Math.abs(coalescePath('scheduleCYLA.lossRemAftSetOff.balHPlossCurYrAftSetoff')));
		if (hpLossCFL.value > Math.abs(coalescePath('scheduleCYLA.lossRemAftSetOff.balHPlossCurYrAftSetoff'))) {
		...
		var busLossOthThanSpecLossCF = document.getElementsByName('scheduleCFL.currentAYloss.lossSummaryDetail.busLossOthThanSpecLossCF')[0];
		setEditableFieldValue(busLossOthThanSpecLossCF,Math.abs(coalescePath('scheduleCYLA.lossRemAftSetOff.balBusLossAftSetoff')));
		if (busLossOthThanSpecLossCF.value > Math.abs(coalescePath('scheduleCYLA.lossRemAftSetOff.balBusLossAftSetoff'))) {
			busLossOthThanSpecLossCF.value = Math.abs(coalescePath('scheduleCYLA.lossRemAftSetOff.balBusLossAftSetoff'));
		} else {
			busLossOthThanSpecLossCF.value = busLossOthThanSpecLossCF.value;
		}
...
/*		document.getElementsByName('scheduleCFL.currentAYloss.lossSummaryDetail.lossFrmSpecBusCF')[0].value = parseInt(0,10);
		...
		if(coalescePath('itr4ScheduleBP.specBusinessInc.adjustedPLFrmSpecuBus') < 0 ){
			...
			var lossFrmSpecBusCF = document.getElementsByName('scheduleCFL.currentAYloss.lossSummaryDetail.lossFrmSpecBusCF')[0];
			
			setEditableFieldValue(lossFrmSpecBusCF,Math.abs(coalescePath('itr4ScheduleBP.specBusinessInc.adjustedPLFrmSpecuBus')));
			if (lossFrmSpecBusCF.value > Math.abs(coalescePath('itr4ScheduleBP.specBusinessInc.adjustedPLFrmSpecuBus'))) {
				lossFrmSpecBusCF.value = Math.abs(coalescePath('itr4ScheduleBP.specBusinessInc.adjustedPLFrmSpecuBus'));
			} else {
				lossFrmSpecBusCF.value = lossFrmSpecBusCF.value;
			}
			
			
		}else{
			document.getElementsByName('scheduleCFL.currentAYloss.lossSummaryDetail.lossFrmSpecBusCF')[0].value = 0;
		}
		...
		if(coalescePath('itr4ScheduleBP.specifiedBusinessInc.pLFrmSpecifiedBus') < 0){
			...
			var lossFrmSpecifiedBusCF = document.getElementsByName('scheduleCFL.currentAYloss.lossSummaryDetail.lossFrmSpecifiedBusCF')[0];
			setEditableFieldValue(lossFrmSpecifiedBusCF,Math.abs(coalescePath('itr4ScheduleBP.specifiedBusinessInc.pLFrmSpecifiedBus')));
			if (lossFrmSpecifiedBusCF.value > Math.abs(coalescePath('itr4ScheduleBP.specifiedBusinessInc.pLFrmSpecifiedBus'))) {
				lossFrmSpecifiedBusCF.value = Math.abs(coalescePath('itr4ScheduleBP.specifiedBusinessInc.pLFrmSpecifiedBus'));
			} else {
				lossFrmSpecifiedBusCF.value = lossFrmSpecifiedBusCF.value;
			}

		}else
			{
			document.getElementsByName('scheduleCFL.currentAYloss.lossSummaryDetail.lossFrmSpecifiedBusCF')[0].value=0;
			}
		...
		var stcgLoss = document.getElementsByName('scheduleCFL.currentAYloss.lossSummaryDetail.stcgLossCF')[0];
		setEditableFieldValue(stcgLoss, totalSTCG);

		if (stcgLoss.value > totalSTCG) {
			stcgLoss.value = totalSTCG;
		} else {
			stcgLoss.value = stcgLoss.value;
		}

		var ltcgLoss = document.getElementsByName('scheduleCFL.currentAYloss.lossSummaryDetail.ltcgLossCF')[0];
		setEditableFieldValue(ltcgLoss, totalLTCG);

		if (ltcgLoss.value > totalLTCG) {
			ltcgLoss.value = totalLTCG;
		} else {
			ltcgLoss.value = ltcgLoss.value;
		}
		...
		if(coalescePath('scheduleOS.incFromOwnHorse.balanceOwnRaceHorse') < 0){
			var osLoss = document.getElementsByName('scheduleCFL.currentAYloss.lossSummaryDetail.othSrcLossRaceHorseCF')[0];
			setEditableFieldValue(osLoss,Math.abs(coalescePath('scheduleOS.incFromOwnHorse.balanceOwnRaceHorse')));
			if (osLoss.value > Math.abs(coalescePath('scheduleOS.incFromOwnHorse.balanceOwnRaceHorse'))) {
				osLoss.value = Math.abs(coalescePath('scheduleOS.incFromOwnHorse.balanceOwnRaceHorse'));
			} else {
				osLoss.value = osLoss.value;
			}
		}else
			{
			document.getElementsByName('scheduleCFL.currentAYloss.lossSummaryDetail.othSrcLossRaceHorseCF')[0].value=0;
			}
...
function calcTotalICDS(){
    try{
		...
		var	temp=eval( parseInt(coalesce(document.getElementsByName('itrScheduleICDS.accntPolicies')[0].value),10) +
    		...
    		document.getElementsByName('partaoi.profDeviatDueAcctMethN')[0].value = parseInt(coalesce(totalNetAmtNegative.value),10);
	...
	var allInputTags = tcsTAB.getElementsByTagName('input');
		for(var i = 0; i < allInputTags.length; i++) {
			...
			if(eval(parseInt(coalesce(allInputTags[i].value),10)) >  eval(parseInt(coalesce(allInputTags[i-1].value),10) + parseInt(coalesce(allInputTags[i-2].value),10))){
					...
					addError(allInputTags[i],'Amount in field Col (7) cannot be more than Col (5) or Col (6) as the case may be.',true);
					j.setFieldError(allInputTags[i].name,'Amount in field Col (7) cannot be more than Col (5) or Col (6) as the case may be.');
...
try{
	...
	document.getElementsByName('partaoi.amtDisallUs43BPyNowAll.amtUs43B.totAmtUs43B')[0].value = eval(
			...
			parseInt(coalesceSetRet('partaoi.amtDisallUs43BPyNowAll.amtUs43B.railwayAssetsPayable'),10)+
	...
	document.getElementsByName('partaoi.amtExciseCustomsVATOutstanding.exciseCustomsVAT.totExciseCustomsVAT')[0].value = eval(
			...
			parseInt(coalesceSetRet('partaoi.amtExciseCustomsVATOutstanding.exciseCustomsVAT.csAtxCgst'),10)+
			parseInt(coalesceSetRet('partaoi.amtExciseCustomsVATOutstanding.exciseCustomsVAT.csAtxSgst'),10)+
			parseInt(coalesceSetRet('partaoi.amtExciseCustomsVATOutstanding.exciseCustomsVAT.csAtxIgst'),10)+
			parseInt(coalesceSetRet('partaoi.amtExciseCustomsVATOutstanding.exciseCustomsVAT.csAtxUTgst'),10)+
...
function calSchS(tableId){
	...
	var empCategory = document.getElementsByName('partAGEN1.personalInfo.employerCategory')[0].value;
	...
	if (empCategory == 'GOV' || empCategory == 'PSU'){
	...
	}else if (empCategory == 'OTH'){
		 if((parseInt(salaryTotal,0) < parseInt( coalesce(deductionUS16.value)  ,10)) || parseInt( coalesce(deductionUS16.value),10) > 5000) {
				addErrorXHTML(document.getElementsByName('scheduleS.salaries['+i+'].salarys.deductionUnderSection16')[0],'Deduction u/s 16 should not exceed ' + Math.min(5000,zeroOrMore(salaryTotal)),true);
				document.getElementsByName('scheduleS.salaries['+i+'].salarys.deductionUnderSection16')[0].value="0";
		}
	}else if (empCategory == 'NA'){
		if((parseInt(salaryTotal,0) < parseInt( coalesce(deductionUS16.value)  ,10)) || parseInt( coalesce(deductionUS16.value),10) > 0) {
		addErrorXHTML(document.getElementsByName('scheduleS.salaries['+i+'].salarys.deductionUnderSection16')[0],'Deduction u/s 16 should not exceed '+ Math.min(0,zeroOrMore(salaryTotal)),true);
		document.getElementsByName('scheduleS.salaries['+i+'].salarys.deductionUnderSection16')[0].value="0";
		}
	}
...
function addScheduleSalary() {
	...
	// 'Add Salary'
	var subTableId = 'scheduleOtherAllow';
	 var lastIndex=eval(parseInt(noOfRows,10)-3);
	var lastTab = eval(parseInt(mainTable[lastIndex].getElementsByTagName('table')[0].id.substring(18), 10) + 1);
	var newTableId =subTableId+ lastTab;
	var iterate = eval(parseInt(totRow) - 1);
	for (var i = 0; i < mainTable.length; i++) {
		var cloneNode = mainTable[i].cloneNode(true);
		...
		if (flag) {
			...
			if (cloneNode.getElementsByTagName('table').length > 0) {
				cloneNode.getElementsByTagName('table')[0].setAttribute(
						'id', newTableId);
				cloneNode.getElementsByTagName('img')[0].setAttribute(
						'onclick', 'addRowToTable(' + '\'' + newTableId
								+ '\',3,2,this);');
				cloneNode.getElementsByTagName('img')[1].setAttribute(
						'onclick', 'deleteRowTable(' + '\'' + newTableId
								+ '\',1,2);calcTotalOtherAllow();');
			}
	...
	if (document.getElementById(newTableId).rows.length > 3) {
		$('#' + newTableId + ' input').attr("checked", true);
		deleteRowTable(newTableId, 1,2);
		$('#' + newTableId + ' input').attr("checked", false);
	}
...
//Add Salary on Import
function addScheduleSalaryOnImport() {
	try{
	var mainTable = document.getElementById('scheduleSalaryMain').rows;
	var tobeInsertBefore = document.getElementById('scheduleSalaryAddRow');
	var flag = false;
...
try{
    ...
    var incRecCredPL5BBGHeads115BBG = document.getElementsByName('itr4ScheduleBP.businessIncOthThanSpec.incRecCredPLOthHeads.us115BBG')[0]; incRecCredPL5BBGHeads115BBG.value = coalesce(incRecCredPL5BBGHeads115BBG.value);
	...
	var expDebToPLOthHeadsUndSec115BBG = document.getElementsByName('itr4ScheduleBP.businessIncOthThanSpec.expDebToPLOthHeads.us115BBG')[0]; expDebToPLOthHeadsUndSec115BBG.value = coalesceSetRet('itr4ScheduleBP.businessIncOthThanSpec.expDebToPLOthHeads.us115BBG');
	...
	var anyOthIncNotInclInSalary = document.getElementsByName('itr4ScheduleBP.businessIncOthThanSpec.anyOthIncNotInclInSalary')[0];  anyOthIncNotInclInSalary.value = coalesceSetRet('itr4ScheduleBP.businessIncOthThanSpec.anyOthIncNotInclInSalary');
	var anyOthIncNotInclInBonus = document.getElementsByName('itr4ScheduleBP.businessIncOthThanSpec.anyOthIncNotInclInBonus')[0];  anyOthIncNotInclInBonus.value = coalesceSetRet('itr4ScheduleBP.businessIncOthThanSpec.anyOthIncNotInclInBonus');
	var anyOthIncNotInclInCommission = document.getElementsByName('itr4ScheduleBP.businessIncOthThanSpec.anyOthIncNotInclInCommission')[0];  anyOthIncNotInclInCommission.value = coalesceSetRet('itr4ScheduleBP.businessIncOthThanSpec.anyOthIncNotInclInCommission');
	var anyOthIncNotInclInInterest = document.getElementsByName('itr4ScheduleBP.businessIncOthThanSpec.anyOthIncNotInclInInterest')[0];  anyOthIncNotInclInInterest.value = coalesceSetRet('itr4ScheduleBP.businessIncOthThanSpec.anyOthIncNotInclInInterest');
	var anyOthIncNotInclInOthers = document.getElementsByName('itr4ScheduleBP.businessIncOthThanSpec.anyOthIncNotInclInOthers')[0];  anyOthIncNotInclInOthers.value = coalesceSetRet('itr4ScheduleBP.businessIncOthThanSpec.anyOthIncNotInclInOthers');
	...
	// 25 filed 3a + 4d schedule IO
	var profDeviatDueAcctMeth = document.getElementsByName('partaoi.profDeviatDueAcctMeth')[0]; profDeviatDueAcctMeth.value = coalesceSetRet('partaoi.profDeviatDueAcctMeth');
	var effectOnPL = document.getElementsByName('partaoi.methodOfValClgStk.effectOnPL')[0]; effectOnPL.value = coalesceSetRet('partaoi.methodOfValClgStk.effectOnPL');
	var anyOthIncNotInclInExpDisallowPLN = document.getElementsByName('itr4ScheduleBP.businessIncOthThanSpec.anyOthIncNotInclInExpDisallowPLN')[0];
	anyOthIncNotInclInExpDisallowPLN.value = coalesceSetRet('itr4ScheduleBP.businessIncOthThanSpec.anyOthIncNotInclInExpDisallowPLN');
	var profDeviatDueAcctMethN = document.getElementsByName('partaoi.profDeviatDueAcctMethN')[0]; profDeviatDueAcctMethN.value = coalesceSetRet('partaoi.profDeviatDueAcctMethN');
	var effectOnPLN = document.getElementsByName('partaoi.methodOfValClgStk.effectOnPLN')[0]; effectOnPLN.value = coalesceSetRet('partaoi.methodOfValClgStk.effectOnPLN');
	var adjICDS = document.getElementsByName('itr4ScheduleBP.businessIncOthThanSpec.adjICDS')[0];adjICDS.value = coalesceSetRet('itr4ScheduleBP.businessIncOthThanSpec.adjICDS');

	//var bp_us115BBG = document.getElementsByName('itr4ScheduleBP.businessIncOthThanSpec.incRecCredPLOthHeads.us115BBG')[0];adjICDS.value = coalesceSetRet('itr4ScheduleBP.businessIncOthThanSpec.incRecCredPLOthHeads.us115BBG');
	...
	for(var i = 0; i < tab.rows.length-3; i++) {
        ...
        // 6. Balance ((1- 2a - 2b - 3a -3b -3e - 3f - 3c - 3d -3e  - 4 - 5d)) bp_us115BBG
        balancePLOthThanSpecBus.value = eval(parseInt(profBfrTaxPL.value ,10)) - eval(parseInt(netPLFromSpecBus.value ,10)) - eval(parseInt(netProfLossSpecifiedBus.value,10)) - eval(parseInt(incRecCredPLOthHeadsSalary.value,10)) - eval(parseInt(incRecCredPLOthHeadsHouseProperty.value,10))- eval(parseInt(incRecCredPLOthHeadsCapitalGains.value,10))- eval(parseInt(incRecCredPLOthHeadsOthSources.value,10)) - eval(parseInt(incRecCredPLOthHeads115BBF.value,10))  - eval(parseInt(incRecCredPL5BBGHeads115BBG.value,10))  - eval(parseInt(plUs44SChapXIIG.value,10)) - eval(parseInt(totExempInc.value,10));
        // 9. Total (7 + 8)
        totExpDebPL.value =  eval(parseInt(expDebToPLOthHeadsSalary.value,10)) + eval(parseInt(expDebToPLOthHeadsHouseProperty.value,10)) +eval(parseInt(expDebToPLOthHeadsCapitalGains.value,10)) +eval(parseInt(expDebToPLOthHeadsOthSources.value,10))+eval(parseInt(expDebToPLOthHeads115BBF.value,10)) + eval(parseInt(expDebToPLOthHeadsUndSec115BBG.value,10))  + eval(parseInt(expDebToPLExemptInc.value,10)) ;
        ...
        // New 25 Filed
        anyOthIncNotInclInExpDisallowPLN.value = eval(parseInt(profDeviatDueAcctMeth.value,10)) + eval(parseInt(effectOnPL.value,10));
//24
        anyOthIncNotInclInExpDisallowPL.value = eval(parseInt(anyOthIncNotInclInSalary.value,10)) + eval(parseInt(anyOthIncNotInclInBonus.value,10))
       + eval(parseInt(anyOthIncNotInclInCommission.value,10) + eval(parseInt(anyOthIncNotInclInInterest.value,10))  + eval(parseInt(anyOthIncNotInclInOthers.value,10)));
        ...
        totAfterAddToPLDeprOthSpecInc.value = eval(parseInt(amtDebPLDisallowUs36.value,10)) + eval(parseInt(deemedIncomeUs43CA.value,10))
        + eval(parseInt(amtDebPLDisallowUs37.value,10)) + eval(parseInt(amtDebPLDisallowUs40.value,10))
        + eval(parseInt(amtDebPLDisallowUs40A.value,10)) + eval(parseInt(amtDebPLDisallowUs43B.value,10))
        + eval(parseInt(interestDisAllowUs23SMEAct.value,10)) + eval(parseInt(deemIncUs41.value,10))
        + eval(parseInt(deemIncUs3380HHD80IA.value,10)) + eval(parseInt(othItemDisallowUs28To44DA.value,10))
        + eval(parseInt(anyOthIncNotInclInExpDisallowPL.value,10) + eval(parseInt(anyOthIncNotInclInExpDisallowPLN.value,10)));
        ...
        totDeductionAmts.value = eval(parseInt(deductUs321Iii.value,10)) + eval(parseInt(debPLUs35ExcessAmt.value,10)) + eval(parseInt(amtDisallUs40NowAllow.value,10))
        + eval(parseInt(amtDisallUs43BNowAllow.value,10)) /*+ eval(parseInt(excessAmtDeduct35AC.value,10))*/ + eval(parseInt(anyOthAmtAllDeduct.value,10))
        + eval(parseInt(deductUs32AD.value,10)) + eval(parseInt(adjICDS.value,10));
        ...
        // 35. Profit or loss before deduction under section 10A/10AA/10B/10BA (32 + 33xi)
...
function calcTotScheduleAMTC(){
    try{
        ...
        var totAmtcCredSetOffPY4 = document.getElementsByName('scheduleAMTC.scheduleAMTCUtil.prevAY[3].amtCreditSetOfEy')[0];
        ...
        var amtCreditFwdCY = document.getElementsByName('scheduleAMTC.scheduleAMTCUtil.prevAY[4].amtCreditFwd')[0];
        var amtCreditBalBroughtFwd = document.getElementsByName('scheduleAMTC.scheduleAMTCUtil.prevAY[4].amtCreditBalBroughtFwd')[0];
        var amtCreditUtilized = document.getElementsByName('scheduleAMTC.scheduleAMTCUtil.prevAY[4].amtCreditUtilized')[0];
        var balAmtCreditCarryFwd = document.getElementsByName('scheduleAMTC.scheduleAMTCUtil.prevAY[4].balAmtCreditCarryFwd')[0];

        amtCreditBalBroughtFwd.value = eval(parseInt(coalesce(amtCreditFwdCY.value),10));
        balAmtCreditCarryFwd.value =  eval(parseInt(coalesce(amtCreditBalBroughtFwd.value),10))-eval(parseInt(coalesce(amtCreditUtilized.value),10));
        ...
        totAmtcCredBFCY.value = eval(parseInt(coalesce(totAmtcCredGrossCY.value),10))-eval(parseInt(coalesce(totAmtcCredSetOffPY4.value),10));
        ...
        totBalAmtcCredCFPY3.value = eval(parseInt(coalesce(totAmtcCredBFPY3.value),10))-eval(parseInt(coalesce(totAmtcCredUtilPY3.value),10));
		        document.getElementsByName('itrScheduleAMTC.totAmtCreditUtilisedCY')[0].value = eval(parseInt(
				coalesce(totAmtcCredUtilPY1.value), 10))
				+ eval(parseInt(coalesce(totAmtcCredUtilPY2.value), 10))
				+ eval(parseInt(coalesce(totAmtcCredUtilPY3.value), 10))
				+ eval(parseInt(coalesce(totAmtcCredUtilCY.value), 10))
				+ eval(parseInt(coalesce(amtCreditUtilized.value), 10));
        ...
        var tempTotal = eval(parseInt(coalesce(section90.value,10))) +
        				eval(coalesce(parseInt(section91.value,10))) -
        				eval(coalesce(parseInt(grossTaxLiability.value,10)));

        if(tempTotal > 0){

        	totAmtcCredGross.value = totAmtcCredGross.value - tempTotal;
        }

   	 	if(document.getElementsByName('scheduleAMTC.scheduleAMTCUtil.amtCreditFwd')[0].value<0){
   	 		totAmtcCredGross.value=0;
   	 	}

        balAmtcCreditCarriedFwdCY.value = totAmtcCredGross.value;

        if(balAmtcCreditCarriedFwdCY<0){
        	j.setFieldError('scheduleAMTC.scheduleAMTCUtil.balAmtCreditCarryFwd','The amount of AMTC Current AY cannot be  negative');
     		addErrorXHTML(document.getElementsByName('scheduleAMTC.scheduleAMTCUtil.balAmtCreditCarryFwd')[0],'The amount of AMTC Current AY cannot be  negative',true);
     		balAmtcCreditCarriedFwdCY.value=parseInt(0,10);
        }

		        document.getElementsByName('itrScheduleAMTC.totAMTGross')[0].value = eval(parseInt(coalesce(
				totAmtcCredGross.value, 10)))
				+ eval(coalesce(parseInt(totAmtcCredGrossPY1.value, 10)))
				+ eval(coalesce(parseInt(totAmtcCredGrossPY2.value, 10)))
				+ eval(coalesce(parseInt(totAmtcCredGrossPY3.value, 10)))
				+ eval(coalesce(parseInt(totAmtcCredGrossCY.value, 10)))
				+ eval(coalesce(parseInt(amtCreditFwdCY.value, 10)));

		document.getElementsByName('itrScheduleAMTC.totSetOffEys')[0].value = eval(parseInt(coalesce(
				totAmtcCredSetOffPY1.value, 10)))
				+ eval(parseInt(coalesce(totAmtcCredSetOffPY2.value, 10)))
				+ eval(parseInt(coalesce(totAmtcCredSetOffPY3.value, 10)))
				+ eval(parseInt(coalesce(totAmtcCredSetOffPY4.value, 10)));

		document.getElementsByName('itrScheduleAMTC.totBalBF')[0].value = eval(parseInt(coalesce(
				totAmtcCredBFPY1.value, 10)))
				+ eval(parseInt(coalesce(totAmtcCredBFPY2.value, 10)))
				+ eval(parseInt(coalesce(totAmtcCredBFPY3.value, 10)))
				+ eval(parseInt(coalesce(totAmtcCredBFCY.value, 10)))
				+ eval(parseInt(coalesce(amtCreditBalBroughtFwd.value, 10)));

		        document.getElementsByName('itrScheduleAMTC.totBalAMTCreditCF')[0].value = eval(parseInt(coalesce(
				totBalAmtcCredCFPY1.value, 10)))
				+ eval(parseInt(coalesce(totBalAmtcCredCFPY2.value, 10)))
				+ eval(parseInt(coalesce(totBalAmtcCredCFPY3.value, 10)))
				+ eval(coalesce(parseInt(balAmtcCreditCarriedFwdCY.value, 10)))
				+ eval(parseInt(coalesce(totBalAmtcCredCFCY.value, 10)))
				+ eval(parseInt(coalesce(balAmtCreditCarryFwd.value, 10)));

		        document.getElementsByName('itrScheduleAMTC.taxSection115JD')[0].value = document
				.getElementsByName('itrScheduleAMTC.totAmtCreditUtilisedCY')[0].value;

		        document.getElementsByName('itrScheduleAMTC.amtLiabilityAvailable')[0].value = document
				.getElementsByName('itrScheduleAMTC.totBalAMTCreditCF')[0].value;
...
function validateAMTC(){
     ...
     if(parseInt(coalesce(amtCreditUtilized.value),10) > parseInt(coalesce(amtCreditBalBroughtFwd.value),10)){

        	j.setFieldError('scheduleAMTC.scheduleAMTCUtil.prevAY[4].amtCreditUtilized','The amount of AMT credit C cannot exceed B3');
    		addErrorXHTML(document.getElementsByName('scheduleAMTC.scheduleAMTCUtil.prevAY[4].amtCreditUtilized')[0],'The amount of AMT credit C cannot exceed B3',true);
    		amtCreditUtilized.value=parseInt(0,10);
    		balAmtCreditCarryFwd.value=parseInt(0,10);
		    		document.getElementsByName('itrScheduleAMTC.totAmtCreditUtilisedCY')[0].value = eval(parseInt(
				coalesce(totAmtcCredUtilPY1.value), 10))
				+ eval(parseInt(coalesce(totAmtcCredUtilPY2.value), 10))
				+ eval(parseInt(coalesce(totAmtcCredUtilCY.value), 10))
...
function caclDedSchVIA(){
	...
	var sec80DA = document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.sec80DHealthInsurancePremiumUsr')[0];
	var sec80DB = document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.sec80DMedicalExpenditureUsr')[0];
	var sec80DC = document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.sec80DPreventiveHealthCheckUpUsr')[0];


	var sec80DASysCal = document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.healthInsurancePremiumHiddenValue')[0];
	var sec80DBSysCal = document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.medicalExpenditureHiddenValue')[0];
	var sec80DCSysCal = document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.preventiveHealthCheckUpHiddenValue')[0];
	...
	// Changes for 80CCD(1) and 80CCD(2) Only 3 field in salary is considered

	var tab = document.getElementById('scheduleSalaryMain');
	var rowcount = tab.rows.length;
	var salaryCount = parseInt(rowcount / 14, 10);
	var salaryTotal = 0;
	for (var i = 0; i < salaryCount; i++) {
	...
	salaryTotal = salaryTotal + eval(parseInt(coalesce(salary.value), 10)
	...
	var temp = Math.round(eval(parseInt(coalesce(salaryTotal),10)) * eval('0.10'));
	if(status =='I' ){
	...
	var salUppLimit = Math.round(eval(parseInt(coalesce(salaryTotal),10)) * eval('0.10'));
	var gtiUppLimit = Math.round(eval(parseInt(coalesce(grossTotInc.value),10)) * eval('0.20'));
	...
	var age = calcAge();
	var option80DA = document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.healthInsurancePremium')[0].value;

	if (status == 'I') {

		if(option80DA == '1'){
			if( parseInt(sec80DA.value,10) > eval('25000')){
				sec80DASysCal.value = '25000';

			} else {
				sec80DASysCal.value =  parseInt(sec80DA.value,10);
			}
		}else if(option80DA== '2'&& (resStatus == 'RES' || resStatus == 'NOR')){
			if( parseInt(sec80DA.value,10) > eval('30000')){
				sec80DASysCal.value = '30000';
			} else {
				sec80DASysCal.value =  parseInt(sec80DA.value,10);
			}
			...
			sec80DASysCal.value= parseInt('0',10);
		}
		if(parseInt(gtiLimit ,10) < sec80DASysCal.value){
				sec80DASysCal.value = gtiLimit;
		}


	} else {
		if (gtiLimit > parseInt('25000', 10)) {
			if (parseInt(coalesce(sec80DA.value), 10) > eval('25000')) {

				sec80DASysCal.value = '25000';
			} else {
				sec80DASysCal.value = parseInt(coalesce(sec80DA.value), 10);
			}
		} else {

			if (parseInt(coalesce(sec80DA.value), 10) > gtiLimit) {
				sec80DASysCal.value = gtiLimit;
			} else {
				sec80DASysCal.value = parseInt(coalesce(sec80DA.value), 10);
			}
	...
	var option80DB = document
			.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.medicalExpenditure')[0].value;

	if (status == 'I') {

		if (option80DB == '1' && (resStatus == 'RES' || resStatus == 'NOR')) {
			if (parseInt(sec80DB.value, 10) > eval('30000')) {
				sec80DBSysCal.value = '30000';
			} else {
				sec80DBSysCal.value = parseInt(sec80DB.value, 10);
			}
			...
			if (age > eval('59')
				...
				if (parseInt(sec80DB.value, 10) > eval('60000')) {
					...
					sec80DBSysCal.value = '60000';
				} else {
					sec80DBSysCal.value = parseInt(sec80DB.value, 10);
				}
			} else {

				if (parseInt(sec80DB.value, 10) > eval('55000')) {
					sec80DBSysCal.value = '55000';
				} else {
					sec80DBSysCal.value = parseInt(sec80DB.value, 10);
				}
			...
			sec80DBSysCal.value = parseInt('0', 10);
		}
		if (parseInt(gtiLimit, 10) < sec80DBSysCal.value) {
			sec80DBSysCal.value = gtiLimit;
		}

	} else {
		if (gtiLimit > parseInt('30000', 10)) {
			if (parseInt(coalesce(sec80DB.value), 10) > eval('30000')) {

				sec80DBSysCal.value = '30000';
			} else {
				sec80DBSysCal.value = parseInt(coalesce(sec80DB.value), 10);
			}
		} else {

			if (parseInt(coalesce(sec80DB.value), 10) > gtiLimit) {
				sec80DBSysCal.value = gtiLimit;
			} else {
				sec80DBSysCal.value = parseInt(coalesce(sec80DB.value), 10);
			}
	...
	var option80DC = document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.preventiveHealthCheckUp')[0].value;
	...
	if (status == 'I') {
		...
		if (option80DC == '1' || option80DC == '2' || option80DC == '3') {
			if (parseInt(sec80DC.value, 10) > eval('5000')) {
				sec80DCSysCal.value = '5000';

			} else {
				sec80DCSysCal.value = parseInt(sec80DC.value, 10);
			}
		}else {
			sec80DCSysCal.value = parseInt('0', 10);
		}
		if (parseInt(gtiLimit, 10) < sec80DCSysCal.value) {
			sec80DCSysCal.value = gtiLimit;
		}

	}

	sec80DASysCalFinal = coalesce(sec80DASysCal.value);
	sec80DBSysCalFinal = coalesce(sec80DBSysCal.value);
	sec80DCSysCalFinal = coalesce(sec80DCSysCal.value);

	var totalABC = eval(parseInt(sec80DASysCalFinal,10) + parseInt(sec80DBSysCalFinal,10) + parseInt(sec80DCSysCalFinal,10));
	if(parseInt(totalABC, 10) < parseInt(gtiLimit, 10))
	{
			...
			if (status == 'I') {
				...
				if (parseInt(totalABC, 10) > eval('60000')) {
					...
					sec80DSysCal.value = parseInt(totalABC, 10);
				}
			} else {

				if (parseInt(totalABC, 10) > eval('30000')) {
		...
		//80DD
		//var option80DD = document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DDUsrType')[0].value;
...
// CHECK FOR 80DD
		...
		if (resStatus == 'RES' || resStatus == 'NOR') {
			...
			if (parseInt(coalesce(gtiLimit), 10) > eval('125000')) {
				if (option80DD == '1') {
					if (parseInt(sec80DD.value, 10) > eval('75000')) {
						sec80DDSysCal.value = '75000';
					} else {
						sec80DDSysCal.value = parseInt(sec80DD.value, 10);
					}
				}
				else if (option80DD == '2') {
					if (parseInt(sec80DD.value, 10) > eval('125000')) {
...
//CHECK FOR 80DDB
		...
		var option80DDB = document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DDBUsrType')[0].value;
		...
		if (resStatus == 'RES' || resStatus == 'NOR') {
			...
			if (parseInt(coalesce(gtiLimit), 10) > eval('80000')) {
				...
				if (option80DDB == '1') {
					if (parseInt(sec80DDB.value, 10) > eval('40000')) {
						sec80DDBSysCal.value = '40000';
					} else {
						sec80DDBSysCal.value = parseInt(sec80DDB.value, 10);
					}

				}

				 if (option80DDB == '2') {
					if (parseInt(sec80DDB.value, 10) > eval('60000')) {
						sec80DDBSysCal.value = '60000';
					} else {
						sec80DDBSysCal.value = parseInt(sec80DDB.value, 10);
					}
				 ...
				 if (option80DDB == '3') {
						if (parseInt(sec80DDB.value, 10) > eval('80000')) {
...
// CHECK FOR 80QQB
		 ...
		 var totGrossOS=eval(
					parseInt(coalesceSetRet('scheduleOS.totalOSGross'),10)+
			                    parseInt(coalesceSetRet('partapl.creditsToPL.totCreditsToPL'),10));
		if (status == 'I') {

			if (resStatus == 'RES' || resStatus == 'NOR') {
				if (parseInt(coalesce(gtiLimit), 10) > 0) {
					if (parseInt(isNVL(sec80QQB.value), 10) > parseInt('0', 10)) {
						sec80QQBSysCal.value = Math.min(
								parseInt(totGrossOS, 10),
								parseInt(gtiLimit, 10),  300000, parseInt(
										isNVL(sec80QQB.value), 10));
					} else {
		...
		if (status == 'I') {
			...
			if (resStatus == 'RES' || resStatus == 'NOR') {
				if (parseInt(coalesce(gtiLimit), 10) > 0) {
					if (parseInt(isNVL(sec80RRB.value), 10) > parseInt('0', 10)) {
						sec80RRBSysCal.value = Math.min(
								parseInt(totGrossOS, 10),
								parseInt(gtiLimit, 10),300000, parseInt(
										isNVL(sec80RRB.value), 10));
					} else {
	...
	// CHECK FOR 80U
	var section80UUsrType = document
	.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80UUsrType')[0].value;

	if(status =='I'){
		if (resStatus == 'RES' || resStatus == 'NOR') {
			if (parseInt(coalesce(gtiLimit), 10) > eval('125000')) {
				if (section80UUsrType == '1') {
					if (parseInt(sec80U.value, 10) > eval('75000')) {
						sec80USysCal.value = '75000';
					} else {
						sec80USysCal.value = parseInt(sec80U.value, 10);
					}

				}

				if (section80UUsrType == '2') {
					if (parseInt(sec80U.value, 10) > eval('125000')) {
...
/*	sumDeductionsWithout80GG(sec80CSysCal,sec80CCCSysCal,sec80CCDiSysCal,sec80CCD1BSysCal,sec80CCDiiSysCal,
	...
	sumDeductionsWithout80GG(sec80CSysCal,sec80CCCSysCal,sec80CCDiSysCal,sec80CCD1BSysCal,sec80CCDiiSysCal,
			sec80DSysCal,sec80DDSysCal,sec80DDBSysCal,sec80ESysCal,sec80EESysCal,sec80GSysCal,sec80GGCSysCal,sec80IBASysCal,
			sec80IASysCal,sec80IABSysCal,sec80IBSysCal,sec80ICSysCal,sec80JJASysCal,sec80JJAASysCal,
			sec80USysCal,sec80CCGSysCal,sec80RRBSysCal,sec80QQBSysCal,sec80TTASysCal);
...
.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.sec80DHealthInsurancePremiumUsr')[0];
var sec80DB = document
.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.sec80DMedicalExpenditureUsr')[0];
var sec80DC = document
.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.sec80DPreventiveHealthCheckUpUsr')[0];
var sec80DD=document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DD')[0];
var sec80DDB=document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DDB')[0];
var sec80E=document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80E')[0];
var sec80EE=document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80EE')[0];
...
userEntrdDedPartB.value=eval(parseInt(coalesce(sec80C.value) ,10))+
                         ...
                         eval(parseInt(coalesce(sec80DA.value), 10))+
                         eval(parseInt(coalesce(sec80DB.value), 10))+
                         eval(parseInt(coalesce(sec80DC.value), 10))+
...
function sumDeductions(sec80CSysCalc,sec80CCCSysCalc,sec80CCDiSysCalc,sec80CCD1BSysCalc,sec80CCDiiSysCalc,
	...
	sec80IASysCal,sec80IABSysCal,sec80IBSysCal,sec80ICSysCal,sec80JJASysCal,sec80JJAASysCal,sec80IBASysCal,
...
//alert('dedPartC.valueeeeeeeeeeeee'+dedPartC.value + "sec80IBSysCal.valueeeeeeee "+sec80IBSysCal.value)
...
function calculateTDS(){
	...
	for (var i = 0; i < allInputTagsTDS3.length; i++) {
		if (allInputTagsTDS3[i].name.match("taxCreditedOwnHands$")) {
...
function calculatePL()
{
	...
	totExciseCustomsVAT.value= eval(
		...
		parseInt(coalesce(document.getElementsByName('partapl.creditsToPL.exciseCustomsVAT.csAtxCgst')[0].value,10))+
		parseInt(coalesce(document.getElementsByName('partapl.creditsToPL.exciseCustomsVAT.csAtxSgst')[0].value,10))+
		parseInt(coalesce(document.getElementsByName('partapl.creditsToPL.exciseCustomsVAT.csAtxIgst')[0].value,10))+
		parseInt(coalesce(document.getElementsByName('partapl.creditsToPL.exciseCustomsVAT.csAtxUTgst')[0].value,10))+
	...
	totExciseCustomsVAT7.value= eval(
		...
		parseInt(coalesce(document.getElementsByName('partapl.debitsToPL.debitPlAcnt.dutyTaxPay.exciseCustomsVAT.csAtxCgst')[0].value,10))+
		parseInt(coalesce(document.getElementsByName('partapl.debitsToPL.debitPlAcnt.dutyTaxPay.exciseCustomsVAT.csAtxSgst')[0].value,10))+
		parseInt(coalesce(document.getElementsByName('partapl.debitsToPL.debitPlAcnt.dutyTaxPay.exciseCustomsVAT.csAtxIgst')[0].value,10))+
		parseInt(coalesce(document.getElementsByName('partapl.debitsToPL.debitPlAcnt.dutyTaxPay.exciseCustomsVAT.csAtxUTgst')[0].value,10))+
	...
	/*
	//To dispaly in # schedule GST
	document.getElementsByName('scheduleGST.underGST.totalAmtExp')[0].value = eval(
			parseInt(coalesce(document.getElementsByName('partapl.debitsToPL.debitPlAcnt.purchases')[0].value),10)+
			parseInt(coalesce(document.getElementsByName('partapl.debitsToPL.debitPlAcnt.freight')[0].value),10)+
			parseInt(coalesce(document.getElementsByName('partapl.debitsToPL.debitPlAcnt.donation')[0].value),10)+
			parseInt(coalesce(document.getElementsByName('partapl.debitsToPL.debitPlAcnt.auditFee')[0].value),10) +
			parseInt(coalesce(document.getElementsByName('partapl.debitsToPL.debitPlAcnt.otherExpenses')[0].value),10) );

	//GST totalpay
	document.getElementsByName('scheduleGST.underGST.totalPay')[0].value = eval(
			parseInt(coalesce(document.getElementsByName('scheduleGST.underGST.exemptGST')[0].value),10)+
			parseInt(coalesce(document.getElementsByName('scheduleGST.underGST.compoScheme')[0].value),10)+
			parseInt(coalesce(document.getElementsByName('scheduleGST.underGST.regEntity')[0].value),10) );
...
function adjustCG() {
	...
	if(document.getElementsByName('partAGEN1.filingStatus.residentialStatus')[0].value=='NRI' || ben115HFlg == 'Y'){
		...
		//A5
		document.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.nRISecur115AD.fullConsidtnia')[0].readOnly=false;
		document.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.nRISecur115AD.fullConsidtnib')[0].readOnly=false;
		document.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.nRISecur115AD.fullConsidtnic')[0].readOnly=true;
		document.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.nRISecur115AD.fullConsidtnii')[0].readOnly=false;

		document.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.nRISecur115AD.fullConsideration')[0].readOnly=true;
		...
		//A5
		var fullConsidtnia = document.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.nRISecur115AD.fullConsidtnia')[0];
		var fullConsidtnib = document.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.nRISecur115AD.fullConsidtnib')[0];
		var fullConsidtnic = document.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.nRISecur115AD.fullConsidtnic')[0];
		var fullConsidtnii = document.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.nRISecur115AD.fullConsidtnii')[0];
...
function onStatusChange(){
	...
	if (status.value == 'I') {
		...
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.healthInsurancePremium')[0].disabled = false;
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.medicalExpenditure')[0].disabled = false;
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.preventiveHealthCheckUp')[0].disabled = false;
		...
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.healthInsurancePremium')[0].value = '';
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.healthInsurancePremium')[0].disabled = true;
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.medicalExpenditure')[0].value = '';
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.medicalExpenditure')[0].disabled = true;
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.preventiveHealthCheckUp')[0].value = '';
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.preventiveHealthCheckUp')[0].disabled = true;

		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.sec80DHealthInsurancePremiumUsr')[0].value='';
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.healthInsurancePremiumHiddenValue')[0].value='';
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.sec80DMedicalExpenditureUsr')[0].value='';
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.medicalExpenditureHiddenValue')[0].value='';
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.sec80DPreventiveHealthCheckUpUsr')[0].value='';
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.preventiveHealthCheckUpHiddenValue')[0].value='';
...
function onChngPCC5A(){
	...
	if(typeHP=='Y'){
		addErrorXHTML('','Please enter your share of income in all income heads other than Income from Salary '
				+'.The share of income of the spouse should be filled in Schedule 5A');
	}
	//adjustTDS2();
}
...
//To calculate the sum of section Wise deductions of table D in CG
function sumSectionWiseCGTableD(tableId, arr,section) {
	var tab = document.getElementById(tableId);
	var input = tab.getElementsByTagName("INPUT");
	for (var i = 0; i < input.length; i++) {
		if ((input[i].name.match('amtDeducted$')) && input[i].value != '') {
...
//	sumSectionWise('schduleCGDed', arrDed);
	...
	sumSectionWiseCGTableD('schduleCGDedD1A', arrDed,'54');
	sumSectionWiseCGTableD('schduleCGDedD1B', arrDed,'54B');
	sumSectionWiseCGTableD('schduleCGDedD1C', arrDed,'54D');
	sumSectionWiseCGTableD('schduleCGDedD1D', arrDed,'54EC');
	sumSectionWiseCGTableD('schduleCGDedD1E', arrDed,'54EE');
	sumSectionWiseCGTableD('schduleCGDedD1F', arrDed,'54F');
	sumSectionWiseCGTableD('schduleCGDedD1G', arrDed,'54G');
	sumSectionWiseCGTableD('schduleCGDedD1H', arrDed,'54GA');
	sumSectionWiseCGTableD('schduleCGDedD1I', arrDed,'115F');


	if(arr['54']!=arrDed['54']){
		j.setFieldError('','Deduction under 54 must match with deduction in table D a');
		addErrorXHTML('','Deduction under 54 must match with deduction in table D a',true);
	}
	if(arr['54B']!=arrDed['54B']){
		j.setFieldError('','Deduction under 54B must match with deduction in table D b');
		addErrorXHTML('','Deduction under 54B must match with deduction in table D b',true);
	}
	if(arr['54EC']!=arrDed['54EC']){
		j.setFieldError('','Deduction under 54EC must match with deduction in table D d');
		addErrorXHTML('','Deduction under 54EC must match with deduction in table D d',true);
	}
	if(arr['54EE']!=arrDed['54EE']){
		j.setFieldError('','Deduction under 54EE must match with deduction in table D e');
		addErrorXHTML('','Deduction under 54EE must match with deduction in table D e',true);
	}
	if(arr['54F']!=arrDed['54F']){
		j.setFieldError('','Deduction under 54F must match with deduction in table D f');
		addErrorXHTML('','Deduction under 54F must match with deduction in table D f',true);
	}
/*	if(arr['54GB']!=arrDed['54GB']){
		j.setFieldError('','Deduction under 54GB must match with deduction in table D');
		addErrorXHTML('','Deduction under 54GB must match with deduction in table D',true);
	}*/
	if(arr['115F']!=arrDed['115F']){
		j.setFieldError('','Deduction under 115F must match with deduction in table D i');
		addErrorXHTML('','Deduction under 115F must match with deduction in table D i',true);
	}
	if(arr['54D']!=arrDed['54D']){
		j.setFieldError('','Deduction under 54D must match with deduction in table D c');
		addErrorXHTML('','Deduction under 54D must match with deduction in table D c',true);
	}
	if(arr['54G']!=arrDed['54G']){
		j.setFieldError('','Deduction under 54G must match with deduction in table D g');
		addErrorXHTML('','Deduction under 54G must match with deduction in table D g',true);
	}
	if(arr['54GA']!=arrDed['54GA']){
		j.setFieldError('','Deduction under 54GA must match with deduction in table D h');
		addErrorXHTML('','Deduction under 54GA must match with deduction in table D h',true);
	}
}
...
function setOtherGrossSourceOnChangeCGLTCG() {
	...
	/*var allSectionArray = [ 'B1e', 'B2e', 'B3e_22', 'B3e_5ACA1b', 'B4c','B5e_21ciii', 'B5e_5AC1c', 'B5e_5ADiii','B6c',
                 			'B6f', 'B7e', 'B8'];*/

	var allSectionArray = [ 'B1e', 'B2e', 'B3e', 'B4e_22', 'B4e_5ACA1b','B5c', 'B6e_21ciii', 'B6e_5AC1c','B6e_5ADiii',
                 			'B7c', 'B7f', 'B8e','B9'];

	if (status == 'RES' || status == 'NOR') {
		addAllOptionsCGLTCG(allSectionArray, rowCount);

		var sectionArray = [ 'B5c','B6e_21ciii', 'B6e_5AC1c', 'B6e_5ADiii','B7c', 'B7f'];
...
/*  //DTAAOS
    document.getElementsByName('scheduleSI.splCodeRateTax[1].splRateInc')[0].value=
    	zeroOrMore(parseInt(document.getElementsByName('scheduleOS.incChargblSplRateOS.nriIncTaxDtaa.totAmtUnderDtaa')[0].value,10));*/
    ...
    document.getElementsByName('scheduleSI.splCodeRateTax[1].splRateInc')[0].value= zeroOrMore(parseInt(
		...
		+ parseInt(
				document
				.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.stcgUnderDtaa.AmtStcgUnderDtaa8b')[0].value,
		10)
		+ parseInt(
				document
				.getElementsByName('scheduleCGPost45.longTermCapGainPost45.ltcgUnderDtaa.AmtLtcgUnderDtaa10b')[0].value,
		10));
 ...
 //5BBF_BP
   ...
   //5BBG_BP
   document.getElementsByName('scheduleSI.splCodeRateTax[9].splRateInc')[0].value= zeroOrMore(parseInt(document.getElementsByName('itr4ScheduleBP.businessIncOthThanSpec.incRecCredPLOthHeads.us115BBG')[0].value,10));
    ...
    for(var i in simap){
        ...
        if(simap[i]!='undefined' && simap[i]!=null && simap[i]!=0){
            ...
            if(!secAdded && !(i=='68' || i=='69' ||i=='69A' || i=='69B' ||i=='69C' || i=='69D'||
            		i=='aggrtvaluewithoutcons562x' || i=='immovpropwithoutcons562x' ||
...
function deleteSIRow(){
    ...
    if(parseInt(noRows,10) > 12){

    for(var i=10;i<parseInt(noRows,10)-2;i++){
       siTable.deleteRow(11);
    }
...
function getSectionTextMap(key){
    var sectionTextMap={"1":"111 - Tax on accumulated balance of recognised PF",
            ...
            "5BBDA":"115BBDA -Dividend Income from domestic company exceeding 10Lakh",
            ...
            "5BBG_BP":"115BBG -Tax on income from transfer of carbon credits",
            "5BBE":"115BBE - Tax on income referred to in sections 68 or 69 or 69A or 69B or 69C or 69D",
            "Tot562x":"Income of the nature referred to in section 56(2)(x) which is chargeable to tax",
...
function enable54GBCompanyPAN() {
	var tab = document.getElementById('ltcgDeduction1');
	...
	for(var i=0; i<inputs.length; i++){
		if(inputs[i].name.match('section$')){
		...
		if((status=='I') && (resStatus == 'RES' || resStatus=='NOR') && ( eval(age)> eval(59) ) &&  (eval(age) <= eval(79))){
			if ( eval(virtualTotInc) <= eval('300000')){
				...
				if((eval(virtualTotInc) >= eval('300001')) && (eval(virtualTotInc) <= eval('500000'))){
					var temp = (eval(virtualTotInc) - eval ('300000')) * eval('0.05');
					...
					virtualTaxPayable = Math.round(eval(temp) + eval('10000'));
				} else if(eval(virtualTotInc) >= eval('1000001')) {
					var temp = (eval(virtualTotInc) - eval ('1000000')) * eval('0.30');
					virtualTaxPayable = Math.round(eval(temp) + eval('110000'));
				}
			}
			...
			if ( eval(virtualTotInc) <= eval('250000')){
				...
				if((eval(virtualTotInc) >= eval('250001')) && (eval(virtualTotInc) <= eval('500000'))){
					var temp = (eval(virtualTotInc) - eval ('250000')) * eval('0.05');
					virtualTaxPayable = Math.round(eval(temp));
				} else if((eval(virtualTotInc) >= eval('500001')) && (eval(virtualTotInc) <= eval('1000000'))) {
					var temp = (eval(virtualTotInc) - eval ('500000')) * eval('0.20');
					virtualTaxPayable = Math.round(eval(temp) + eval('12500'));
				} else if(eval(virtualTotInc) >= eval('1000001')) {
					var temp = (eval(virtualTotInc) - eval ('1000000')) * eval('0.30');
					virtualTaxPayable = Math.round(eval(temp) + eval('112500'));
				}
			}
		}
		var rebate87A = document.getElementsByName('partBTTI.computationOfTaxLiability.taxPayableOnTI.rebate87A')[0].value;
...
alert(' calCGA6TotalSumcalCGA6TotalSum ');
...
function alertItr4User() {
	...
	var sum = 0;
	var amt = 0;
	var otherAllowancesSalaryTot= getTotForSalaryOtherAllowances();
	...
	var salaryTotal = 0;
	for (var i = 0; i < salaryCount; i++) {
		var travelConcession = document.getElementsByName('scheduleS.salaries[' + i
		...
		exemptIncomeTotal = eval(parseInt(coalesce(travelConcession.value), 10)
				+ parseInt(coalesce(taxPaidNonMonetary.value), 10)
				+ parseInt(coalesce(allowanceExpHouseRent.value), 10)
				+ parseInt(coalesce(otherAllowances.value), 10));

		}


	if ((parseInt(coalesce(incSal), 10)+parseInt(otherAllowancesSalaryTot, 10))< tdsSalminusTenPer && (exemptIncomeTotal <= 0)) {
		addErrorXHTML(
				'',
				'Please ensure to fill exempt income pertaining to salary.');
		j.setFieldError('','Please ensure to fill exempt income pertaining to salary.');
	}
	/*if ((parseInt(coalesce(incSal), 10)+parseInt(otherAllowancesSalaryTot, 10)) < tdsSalminusTenPer && (exemptIncomeTotal > 0)) {
		errText += (i++)
	...
	if(fileSec=='20'){
		...
		errText+=(i++)+". Sec139(4) read with section 119(2)(b) should be filed after expiry of due date mentioned in 139(1)/139(4).\n\n";
	}
	if(fileSec=='19'){
...
function display92CDVerification(type) {
	...
	if(type != 'onload' && fileSec == '20'){
		addErrorXHTML('','Sec139(4) read with section 119(2)(b) should be filed after expiry of due date mentioned in 139(1)/139(4).');
	}
	...
	if(fileSec=='12' || fileSec=='13' || fileSec=='20'){
...
function income115BBG_BP(){
	document.getElementsByName('partBTI.profBusGain.profIncome115BBG')[0].value=
		parseInt(coalesceSetRet('itr4ScheduleBP.businessIncOthThanSpec.incRecCredPLOthHeads.us115BBG'),10);
...
function mandtryAL(){
	...
	var immflag = document.getElementsByName('itr2.scheduleAL.immovableFlag')[0].value; //A dropdown
	var jewflag = document.getElementsByName('itr2.scheduleAL.movableAsset.jewelleryBullionEtc')[0].value; //B i dropdown
	var archflag = document.getElementsByName('itr2.scheduleAL.movableAsset.archCollDrawPaintSulpArt')[0].value; //B ii
	var vehiflag = document.getElementsByName('itr2.scheduleAL.movableAsset.vehiclYachtsBoatsAircrafts')[0].value;//B iii
	var deposflag = document.getElementsByName('itr2.scheduleAL.movableAsset.depositsinbank')[0].value;//B iv a
	var shreflag = document.getElementsByName('itr2.scheduleAL.movableAsset.sharesandsecurities')[0].value; //B iv b
	var insurflag = document.getElementsByName('itr2.scheduleAL.movableAsset.insurancepolicies')[0].value;//B iv c
	var loanflag = document.getElementsByName('itr2.scheduleAL.movableAsset.loansandadvancesgiven')[0].value;//B iv d
	var cashflag = document.getElementsByName('itr2.scheduleAL.movableAsset.cashInHand')[0].value;//B iv e
	var AOPflag = document.getElementsByName('itr2.scheduleAL.interstAOPFlag')[0].value; // C
	var liabflag = document.getElementsByName('itr2.scheduleAL.liabilityInRelatAssets')[0].value;  //D
	...
	if ((immflag != ""))
	{
		if((jewflag =="")||(archflag =="")||(vehiflag =="") ||(deposflag =="") ||(shreflag =="") ||(insurflag =="") ||(loanflag =="")
			...
			addErrorXHTML('' ,'Please fill the amount fields at Point B or /and Point D. If not applicable, enter zeros.');
			j.setFieldError('itr2.scheduleAL','Please fill the amount fields at Point B or /and Point D. If not applicable, enter zeros.');}

		if((AOPflag =="")){

			addErrorXHTML('' ,'Please select an option at Point.C');
			j.setFieldError('itr2.scheduleAL','Please select an option at Point.C');}
	...
	if ((jewflag != ""))
	{
		if(immflag ==""){
			...
			addErrorXHTML('' ,'Please select an option at Point.A');
			j.setFieldError('itr2.scheduleAL','Please select an option at Point.A');}

		if((archflag =="")||(vehiflag =="") ||(deposflag =="") ||(shreflag =="") ||(insurflag =="") ||(loanflag =="")
				||(cashflag =="")||(liabflag =="")){
	...
	if ((archflag != ""))
	{
		...
		if((jewflag =="")||(vehiflag =="") ||(deposflag =="") ||(shreflag =="") ||(insurflag =="") ||(loanflag =="")
				||(cashflag =="")||(liabflag =="")){
	...
	if ((vehiflag != ""))
	{
		if(immflag ==""){
			...
			addErrorXHTML('' ,'Please select an option at Point.A');
			j.setFieldError('itr2.scheduleAL','Please select an option at Point.A');}
		if((jewflag =="")||(archflag =="") ||(deposflag =="") ||(shreflag =="") ||(insurflag =="") ||(loanflag =="")
				||(cashflag =="")||(liabflag =="")){
	...
	if ((deposflag != ""))
	{
		if(immflag ==""){
			...
			addErrorXHTML('' ,'Please select an option at Point.A');
			j.setFieldError('itr2.scheduleAL','Please select an option at Point.A');}
		if((jewflag =="")||(vehiflag =="") ||(archflag =="") ||(shreflag =="") ||(insurflag =="") ||(loanflag =="")
				||(cashflag =="") ||(liabflag =="")){
	...
	if ((shreflag != ""))
	{
		...
		if((jewflag =="")||(vehiflag =="") ||(deposflag =="") ||(archflag =="") ||(insurflag =="") ||(loanflag =="")
				||(cashflag =="") ||(liabflag =="")){
	...
	if ((insurflag != ""))
	{
		...
		if((jewflag =="")||(vehiflag =="") ||(deposflag =="") ||(shreflag =="") ||(archflag =="") ||(loanflag =="")
				||(cashflag =="")||(liabflag =="")){
	...
	if ((loanflag != ""))
	{
		if(immflag ==""){
			...
			addErrorXHTML('' ,'Please select an option at Point.A');
			j.setFieldError('itr2.scheduleAL','Please select an option at Point.A');}
		if((jewflag =="")||(vehiflag =="") ||(deposflag =="") ||(shreflag =="") ||(archflag =="") ||(insurflag =="")
				||(cashflag =="")||(liabflag =="")){
...
/*function priBankMandtry()
{
   ...
   if(ifscCode=="" || bankAcctNo==""||bankName==""){
	...
	for(var i = 0; i < allInputTags.length; i++) {
		alert("BANKING.....!!",allInputTags.length)
...
function enable115HFlag()
{
	...
	if ( status == 'I' &&  (res == 'RES' || res == 'NOR') )
		...
		document.getElementsByName('partAGEN1.filingStatus.benefitUs115HFlg')[0].disabled = false;
			...
			document.getElementsByName('partAGEN1.filingStatus.benefitUs115HFlg')[0].value = 'N';
			}
}
...
{
	var age = calcAge();
	var sec80D  = document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.healthInsurancePremium')[0].value;
	if( (sec80D == '2' || sec80D == '7' ) && age < 60)
		{
		j.setFieldError('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.healthInsurancePremium','Please select a valid option from the dropdown of Sec.80D under Chapter VI-A');
		addErrorXHTML('','Please select a valid option from the dropdown of Sec.80D under Chapter VI-A',true);
		}

	var sec80DB  = document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.medicalExpenditure')[0].value;
	if( (sec80DB == '1' || sec80DB == '3') && age < 60)
		{
		j.setFieldError('scheduleVIA.usrDeductUndChapVIA.section80DHealthInsPremium.medicalExpenditure','Please select a valid option from the dropdown of Sec.80D under Chapter VI-A');
		addErrorXHTML('','Please select a valid option from the dropdown of Sec.80D under Chapter VI-A',true);
		}
...
/*function enableCT()
{
	var scheduleCTFlag = document.getElementsByName('partBTTI.transactionFlagOfYr')[0].value;
	if (scheduleCTFlag == 'Y') {
		addErrorXHTML('',
				'Schedule CT is mandatory. Ensure all the details in Schedule CT are filled');
	}
}*/

//To check Schedule FA Mandatory or not
/*function checkSchCTMandatory() {

	var table1 = checkRowBlank('scheduleCTA', 2, 1);
	var table2 = checkRowBlank('scheduleCTB', 2, 1);
	var table3 = checkRowBlank('scheduleCTC', 2, 1);
	var table4 = checkRowBlank('scheduleCTD', 2, 1);
	var table5 = checkRowBlank('scheduleCTE', 2, 1);

	if (document.getElementsByName('partBTTI.transactionFlagOfYr')[0].value == 'Y') {

		if (table1 && table2 && table3 && table4 && table5) {
			j.setFieldError('itr3.scheduleCT.loanOrDepositSec269SS[0].name',
					'Please enter any one table in Schedule CT.');
			addErrorXHTML('', 'Please enter any one table in Schedule CT.');
		}
	}
}*/

/*function disableScheduleCT() {

	var scheduleCTFlag = document.getElementsByName('partBTTI.transactionFlagOfYr')[0].value;
	removeTableDataCT('scheduleCTA', scheduleCTFlag);
	removeTableDataCT('scheduleCTB', scheduleCTFlag);
	removeTableDataCT('scheduleCTC', scheduleCTFlag);
	removeTableDataCT('scheduleCTD', scheduleCTFlag);
	removeTableDataCT('scheduleCTE', scheduleCTFlag);
}*/

/*// To remove Table Data
function removeTableDataCT(tableID, scheduleCTFlag) {

	var tab = document.getElementById(tableID);

	if (scheduleCTFlag == 'YES') {
		$('#' + tableID + ' input').attr("checked", true);
		deleteRowTable(tableID, 3, 1);
		$('#' + tableID + ' input').attr("checked", false);
	}
...
function scheduleCGA5a(){


	document.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.nRISecur115AD.fullConsideration')[0].value =

		eval(coalesceSetRet("scheduleCGPost45.shortTermCapGainPost45.nRISecur115AD.fullConsidtnii") +
				coalesceSetRet("scheduleCGPost45.shortTermCapGainPost45.nRISecur115AD.fullConsidtnic"));

}

function scheduleCGA6a(){


	document.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.saleOnOtherAssets.fullConsideration')[0].value =

		eval(coalesceSetRet("scheduleCGPost45.shortTermCapGainPost45.saleOnOtherAssets.fullConsidtnii") +
				coalesceSetRet("scheduleCGPost45.shortTermCapGainPost45.saleOnOtherAssets.fullConsidtnic"));

}


function scheduleCGB8a(){


	document.getElementsByName('scheduleCGPost45.longTermCapGainPost45.saleofAssetNA.deductSec48.fullConsideration')[0].value =

		eval(coalesceSetRet("scheduleCGPost45.longTermCapGainPost45.saleofAssetNA.deductSec48.fullConsidtnii") +
				coalesceSetRet("scheduleCGPost45.longTermCapGainPost45.saleofAssetNA.deductSec48.fullConsidtnic"));
...
function calculateTotalDeductions()
{
	...
	var tab = document.getElementById('schduleCGDedD1A');
	var noOfRows = tab.rows.length;
	var sum = 0;
	var amt = 0;
	...
	for (var i = 0; i < (noOfRows - 2); i++) {
		amt = document
				.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54[' + i + '].amtDeducted')[0].value;
		sum = eval(parseInt(sum, 10) + parseInt(coalesce(amt), 10));
	}

	var tab1 = document.getElementById('schduleCGDedD1B');
	var noOfRows1 = tab1.rows.length;
	var sum1 = 0;
	var amt1 = 0;

	for (var i = 0; i < (noOfRows1 - 2); i++) {
		amt1 = document
				.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54B[' + i + '].amtDeducted')[0].value;
		sum1 = eval(parseInt(sum1, 10) + parseInt(coalesce(amt1), 10));
	}

	var tab2 = document.getElementById('schduleCGDedD1C');
	var noOfRows2 = tab2.rows.length;
	var sum2 = 0;
	var amt2 = 0;

	for (var i = 0; i < (noOfRows2 - 2); i++) {
		amt2 = document
				.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54D[' + i + '].amtDeducted')[0].value;
		sum2 = eval(parseInt(sum2, 10) + parseInt(coalesce(amt2), 10));
	}

	var tab3 = document.getElementById('schduleCGDedD1D');
	var noOfRows3 = tab3.rows.length;
	var sum3 = 0;
	var amt3 = 0;

	for (var i = 0; i < (noOfRows3 - 2); i++) {
		amt3 = document
				.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54EC[' + i + '].amtDeducted')[0].value;
		sum3 = eval(parseInt(sum3, 10) + parseInt(coalesce(amt3), 10));
	}

	var tab4 = document.getElementById('schduleCGDedD1E');
	var noOfRows4 = tab4.rows.length;
	var sum4 = 0;
	var amt4 = 0;

	for (var i = 0; i < (noOfRows4 - 2); i++) {
		amt4 = document
				.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54EE[' + i + '].amtDeducted')[0].value;
		sum4 = eval(parseInt(sum4, 10) + parseInt(coalesce(amt4), 10));
	}

	var tab5 = document.getElementById('schduleCGDedD1F');
	var noOfRows5 = tab5.rows.length;
	var sum5 = 0;
	var amt5 = 0;

	for (var i = 0; i < (noOfRows5 - 2); i++) {
		amt5 = document
				.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54F[' + i + '].amtDeducted')[0].value;
		sum5 = eval(parseInt(sum5, 10) + parseInt(coalesce(amt5), 10));
	}

	var tab6 = document.getElementById('schduleCGDedD1G');
	var noOfRows6 = tab6.rows.length;
	var sum6 = 0;
	var amt6 = 0;

	for (var i = 0; i < (noOfRows6 - 2); i++) {
		amt6 = document
				.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54G[' + i + '].amtDeducted')[0].value;
		sum6 = eval(parseInt(sum6, 10) + parseInt(coalesce(amt6), 10));
	}



	var tab7 = document.getElementById('schduleCGDedD1H');
	var noOfRows7 = tab7.rows.length;
	var sum7 = 0;
	var amt7 = 0;

	for (var i = 0; i < (noOfRows7 - 2); i++) {
		amt7 = document
				.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54GA[' + i + '].amtDeducted')[0].value;
		sum7 = eval(parseInt(sum7, 10) + parseInt(coalesce(amt7), 10));
	}


	var tab8 = document.getElementById('schduleCGDedD1I');
	var noOfRows8 = tab8.rows.length;
	var sum8 = 0;
	var amt8 = 0;

	for (var i = 0; i < (noOfRows8 - 2); i++) {
		amt8 = document
				.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs115F[' + i + '].amtDeducted')[0].value;
		sum8 = eval(parseInt(sum8, 10) + parseInt(coalesce(amt8), 10));
	}


	document.getElementsByName('scheduleCGPost45.deducClaimInfo.totDeductClaim')[0].value = eval(
			parseInt(sum, 10) + parseInt(sum1, 10) +
			parseInt(sum2, 10) + parseInt(sum3, 10) +
			parseInt(sum4, 10) + parseInt(sum5, 10) +
			parseInt(sum6, 10) +parseInt(sum7, 10) +
			parseInt(sum8, 10) );
...
function calCSschedule(){


	document.getElementsByName('scheduleCS.openCloseCash.acc_Aiii')[0].value = eval(
			parseInt( coalesce(document.getElementsByName('scheduleCS.openCloseCash.acc_Ai')[0].value ,10)) +
			parseInt( coalesce(document.getElementsByName('scheduleCS.openCloseCash.acc_Aii')[0].value,10))
	);

	document.getElementsByName('scheduleCS.openCloseCash.acc_Bic')[0].value = eval(
			parseInt( coalesce(document.getElementsByName('scheduleCS.openCloseCash.acc_Bia')[0].value,10)) +
			parseInt( coalesce(document.getElementsByName('scheduleCS.openCloseCash.acc_Bib')[0].value,10))
	);

	document.getElementsByName('scheduleCS.openCloseCash.acc_Biic')[0].value = eval(
			parseInt(coalesce(document.getElementsByName('scheduleCS.openCloseCash.acc_Biia')[0].value ,10))+
					parseInt(coalesce(document.getElementsByName('scheduleCS.openCloseCash.acc_Biib')[0].value,10))
	);

	document.getElementsByName('scheduleCS.openCloseCash.acc_Cic')[0].value = eval(
			parseInt(coalesce(document.getElementsByName('scheduleCS.openCloseCash.acc_Cia')[0].value ,10))+
					parseInt(coalesce(document.getElementsByName('scheduleCS.openCloseCash.acc_Cib')[0].value,10))
	);


	document.getElementsByName('scheduleCS.openCloseCash.acc_Ciic')[0].value = eval(
			parseInt(coalesce(document.getElementsByName('scheduleCS.openCloseCash.acc_Ciia')[0].value ,10))+
					parseInt(coalesce(document.getElementsByName('scheduleCS.openCloseCash.acc_Ciib')[0].value,10))
	);

	document.getElementsByName('scheduleCS.openCloseCash.acc_Diii')[0].value = eval(
			parseInt(coalesce(document.getElementsByName('scheduleCS.openCloseCash.acc_Di')[0].value ,10))+
					parseInt(coalesce(document.getElementsByName('scheduleCS.openCloseCash.acc_Dii')[0].value,10))
	);


	document.getElementsByName('scheduleCS.openCloseCash.acc_Biii')[0].value = eval(
			parseInt(coalesce(document.getElementsByName('scheduleCS.openCloseCash.acc_Bic')[0].value ,10))+
					parseInt(coalesce(document.getElementsByName('scheduleCS.openCloseCash.acc_Biic')[0].value,10))
	);

	document.getElementsByName('scheduleCS.openCloseCash.acc_Ciii')[0].value = eval(
			parseInt(coalesce(document.getElementsByName('scheduleCS.openCloseCash.acc_Cic')[0].value ,10))+
			parseInt(coalesce(document.getElementsByName('scheduleCS.openCloseCash.acc_Ciic')[0].value,10))
	);
}

function calGSTschedule(){
	document.getElementsByName('scheduleCS.openCloseCash.acc_Ciii')[0].value = eval(
			parseInt(coalesce(document.getElementsByName('scheduleCS.openCloseCash.acc_Cic')[0].value ,10))+
			parseInt(coalesce(document.getElementsByName('scheduleCS.openCloseCash.acc_Ciic')[0].value,10))
	);
...
function scheduleCGB6a()
{

	var tab = document.getElementById('stcg10pctTab');
	var noOfRows = tab.rows.length;

	for (var i = 0; i < (noOfRows / 16); i++) {
		document.getElementsByName('scheduleCGPost45.longTermCapGainPost45.nRIOnSec112and115['+ i +'].fullConsideration')[0].value
		= eval(coalesceSetRet('scheduleCGPost45.longTermCapGainPost45.nRIOnSec112and115['+ i +'].fullConsidtnii') +
				  coalesceSetRet('scheduleCGPost45.longTermCapGainPost45.nRIOnSec112and115['+ i +'].fullConsidtnic'));
	}
...
function scheduleCGB6a(){
	...
	document.getElementsByName('scheduleCGPost45.longTermCapGainPost45.nRIOnSec112and115[0].fullConsideration')[0].value =

		eval(coalesceSetRet("scheduleCGPost45.longTermCapGainPost45.nRIOnSec112and115[0]fullConsidtnii") +
				coalesceSetRet("scheduleCGPost45.longTermCapGainPost45.nRIOnSec112and115[0]fullConsidtnic"));

}*/

function calcTotFullConA(a,b,c) {

	var afield = document.getElementsByName(a)[0];
	var bfield = document.getElementsByName(b)[0];
	var cfield = document.getElementsByName(c)[0];

	/*if(parseInt(coalesce(afield.value),10) > parseInt(coalesce(bfield.value),10) || parseInt(coalesce(afield.value),10) != parseInt(coalesce(cfield.value),10)){
		 if (parseInt(coalesce(afield.value),10) > parseInt(coalesce(cfield.value),10)) {
	     	j.setFieldError(c,'Please enter the amount higher of a or b');
	 		addErrorXHTML(document.getElementsByName(c)[0],'Please enter the amount higher of a or b',true);
	 		//cfield.value = parseInt(0,10);
	 		cfield.value = '';
		 }
	     }

	 if(parseInt(coalesce(b.value),10) > parseInt(coalesce(a.value),10) || parseInt(coalesce(b.value),10) != parseInt(coalesce(c.value),10)){
		 if (parseInt(coalesce(b.value),10) > parseInt(coalesce(c.value),10)) {
	     	j.setFieldError('scheduleCGPost45.shortTermCapGainPost45.nRISecur115AD.fullConsidtnic','Please enter the amount higher of a or b');
	 		addErrorXHTML(document.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.nRISecur115AD.fullConsidtnic')[0],'Please enter the amount higher of a or b',true);
	 		//cfield.value = parseInt(0,10);
	 		cfield.value = '';
	...
	if(parseInt(coalesce(afield.value),10) > parseInt(coalesce(bfield.value),10)){
		cfield.value = parseInt(coalesce(afield.value),10);
	}
	else{
		cfield.value = parseInt(coalesce(bfield.value),10);
	}

}


function calcTotFullConTable()
{
	var tab = document.getElementById('stcg10pctTab');
	...
	for (var i = 0; i < (noOfRows/16); i++) {
		...
		if(parseInt(coalesce(document.getElementsByName('scheduleCGPost45.longTermCapGainPost45.nRIOnSec112and115['+ i +'].fullConsidtnia')[0].value),10)>parseInt(coalesce(document.getElementsByName('scheduleCGPost45.longTermCapGainPost45.nRIOnSec112and115['+ i +'].fullConsidtnib')[0].value),10)
		){


			document.getElementsByName('scheduleCGPost45.longTermCapGainPost45.nRIOnSec112and115['+ i +'].fullConsidtnic')[0].value=
				parseInt(coalesce(document.getElementsByName('scheduleCGPost45.longTermCapGainPost45.nRIOnSec112and115['+ i +'].fullConsidtnia')[0].value),10);
		...
		else
		{
			...
			document.getElementsByName('scheduleCGPost45.longTermCapGainPost45.nRIOnSec112and115['+ i +'].fullConsidtnic')[0].value=
				parseInt(coalesce(document.getElementsByName('scheduleCGPost45.longTermCapGainPost45.nRIOnSec112and115['+ i +'].fullConsidtnib')[0].value),10);
...

{
	...
	for (var i = 0; i < (noOfRows - 2); i++) {
		...
		if (rateAsPerTreaty > rateAsPerITAct) {
			document
					.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.stcgUnderDtaa['
							+ i + '].applicableRate')[0].value = document
					.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.stcgUnderDtaa['
							+ i + '].rateAsPerITAct')[0].value;
...
function validateSchCGSTCGAmt() {
	var tab = document.getElementById('scheduleStcgDtaa');
	var rowCount = tab.rows.length - 2;

	var sum = 0;

	var totalStcg = eval(coalesceSetRet('scheduleCGPost45.shortTermCapGainPost45.stcgUnderDtaa.totAmtStcgUnderDtaa')
			+ coalesceSetRet('scheduleCGPost45.shortTermCapGainPost45.stcgUnderDtaa.AmtStcgUnderDtaa8b'));

	for (var i = 0; i < rowCount; i++) {
		sum = sum +parseInt(coalesce(document.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.stcgUnderDtaa['
				+ i + '].amount')[0].value),10);
				/*+ document
						.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.stcgUnderDtaa['
								+ i + '].amount')[0].value;*/

		parseInt(coalesce(document.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.stcgUnderDtaa['
				+ i + '].amount')[0].value),10);
	...
	{
		j.setFieldError('',
				'The amount of a+b should be equal to amount in STCG DTAA table');
		addErrorXHTML('',
				'The amount of a+b should be equal to amount in STCG DTAA table', true);

	}
}

function validateSchCGLTCGAmt() {
	var tab = document.getElementById('scheduleLtcgDtaa');
	var rowCount = tab.rows.length - 2;

	var sum = 0;

	var totalStcg = eval(coalesceSetRet('scheduleCGPost45.longTermCapGainPost45.ltcgUnderDtaa.totAmtLtcgUnderDtaa')
			+ coalesceSetRet('scheduleCGPost45.longTermCapGainPost45.ltcgUnderDtaa.AmtLtcgUnderDtaa10b'));

	for (var i = 0; i < rowCount; i++) {
		sum = sum +parseInt(coalesce(document.getElementsByName('scheduleCGPost45.longTermCapGainPost45.ltcgUnderDtaa['
				+ i + '].amount')[0].value),10);

		/*+ document.getElementsByName('scheduleCGPost45.longTermCapGainPost45.ltcgUnderDtaa['
								+ i + '].amount')[0].value;
		*/
	...
	{
		j.setFieldError('',
				'The amount of a+b should be equal to amount in LTCG DTAA table');
		addErrorXHTML('',
				'The amount of a+b should be equal to amount in LTCG DTAA table', true);
...
function enableTextFieldOthSal() {
	var tableName = 'scheduleOtherAllow';
	var tab = document.getElementById('scheduleSalaryMain');
	var rowcount = tab.rows.length;
	var salaryCount = parseInt(rowcount / 14, 10);
	...
	for (var i = 0; i < salaryCount; i++) {
		...
		var subTable = document.getElementById(tableName + (i + 1));

		for (var j = 0; j < subTable.rows.length - 3; j++) {

			var otherAllowancesNature = document
					.getElementsByName('scheduleS.salaries[' + i
							+ '].salarys.otherAllowances.othersIncDtls[' + j
							+ '].natureDesc')[0].value;

			if (otherAllowancesNature == 'OTH') {
				document.getElementsByName('scheduleS.salaries[' + i
						+ '].salarys.otherAllowances.othersIncDtls[' + j
						+ '].othNatOfInc')[0].disabled = false;

			} else {
				document.getElementsByName('scheduleS.salaries[' + i
						+ '].salarys.otherAllowances.othersIncDtls[' + j
						+ '].othNatOfInc')[0].disabled = true;
		...
		for (var i = 0; i < salaryCount; i++) {
			...
			for (var j = 0; j < subTable.rows.length - 3; j++) {
				sum = sum
						+ eval(parseInt(
								coalesce(document
										.getElementsByName('scheduleS.salaries['
												+ i
												+ '].salarys.otherAllowances.othersIncDtls['
												+ j + '].othAmount')[0].value),
								10));
			...
			document.getElementsByName('scheduleS.salaries[' + i
					+ '].salarys.otherAllowances')[0].value = sum;
			...
			if (amt9.value > tempVal) {
				j
						.setFieldError('scheduleTDS2.tdSonOthThanSal[' + i
								...
								'Amount entered in Column (9) cannot be more than Column (6) + TDS field of Column (8)');
				addErrorXHTML(
						document
...
function totalOfAmtCarriedTDS2(el) {
...
function totalOfAmtCarriedTDS3(el) {
...
function populateMobileCode()
{
	...
	state = document.getElementsByName('partAGEN1.personalInfo.address.stateCode')[0];
	country = document.getElementsByName('partAGEN1.personalInfo.address.country')[0];
	...
	if (state.value != '99' && state.value != '-1') {
		...
		document.getElementsByName('partAGEN1.personalInfo.address.countryCodeMobileNoSec')[0].value = '91';
		document.getElementsByName('partAGEN1.personalInfo.address.countryCodeMobileNoSec')[0].disabled = true;
	} else if (state.value == '99') {
...
function disableChapterVIADD(){

	var status = document.getElementsByName('partAGEN1.filingStatus.residentialStatus')[0].value;

	if (status == 'NRI')
		{
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DDUsrType')[0].disabled = true;
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DD')[0].disabled = true;
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DDBUsrType')[0].disabled = true;
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DDB')[0].disabled = true;
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80UUsrType')[0].disabled = true;
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80U')[0].disabled = true;

		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DDUsrType')[0].value ='';
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DD')[0].value ='';
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DDBUsrType')[0].value ='';
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DDB')[0].value ='';
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80UUsrType')[0].value ='';
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80U')[0].value ='';
		...
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DDUsrType')[0].disabled = false;
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DD')[0].disabled = false;
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DDBUsrType')[0].disabled = false;
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80DDB')[0].disabled = false;
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80UUsrType')[0].disabled = false;
		document.getElementsByName('scheduleVIA.usrDeductUndChapVIA.section80U')[0].disabled = false;
		}
}

function checkFor15thFiledValue(){

	if( parseInt(document.getElementsByName('scheduleDOA.building.rateNil.depreciationDetail.propDepreciationNetAgg')[0].value) >
	parseInt(document.getElementsByName('scheduleDOA.building.rateNil.depreciationDetail.depreciationNetAgg')[0].value)  ){
	j.setFieldError('scheduleDOA.building.rateNil.depreciationDetail.propDepreciationNetAgg','Amount cannot be more than the amount entered in Total depreciation');
	addErrorXHTML( document.getElementsByName('scheduleDOA.building.rateNil.depreciationDetail.propDepreciationNetAgg')[0],
	...
	if( parseInt(document.getElementsByName('scheduleDOA.building.rate5.depreciationDetail.propDepreciationNetAgg')[0].value) >
	parseInt(document.getElementsByName('scheduleDOA.building.rate5.depreciationDetail.depreciationNetAgg')[0].value)  ){
	j.setFieldError('scheduleDOA.building.rate5.depreciationDetail.propDepreciationNetAgg','Amount cannot be more than the amount entered in Total depreciation');
	addErrorXHTML( document.getElementsByName('scheduleDOA.building.rate5.depreciationDetail.propDepreciationNetAgg')[0],
			'Amount cannot be more than the amount entered in Total depreciation',
			true);
	}
	...
	if( parseInt(document.getElementsByName('scheduleDOA.building.rate10.depreciationDetail.propDepreciationNetAgg')[0].value) >
	parseInt(document.getElementsByName('scheduleDOA.building.rate10.depreciationDetail.depreciationNetAgg')[0].value)  ){
	j.setFieldError('scheduleDOA.building.rate10.depreciationDetail.propDepreciationNetAgg','Amount cannot be more than the amount entered in Total depreciation');
	addErrorXHTML( document.getElementsByName('scheduleDOA.building.rate10.depreciationDetail.propDepreciationNetAgg')[0],
			'Amount cannot be more than the amount entered in Total depreciation',
			true);
	}
	...
	if( parseInt(document.getElementsByName('scheduleDOA.building.rate100.depreciationDetail.propDepreciationNetAgg')[0].value) >
	parseInt(document.getElementsByName('scheduleDOA.building.rate100.depreciationDetail.depreciationNetAgg')[0].value)  ){
	j.setFieldError('scheduleDOA.building.rate100.depreciationDetail.propDepreciationNetAgg','Amount cannot be more than the amount entered in Total depreciation');
	addErrorXHTML( document.getElementsByName('scheduleDOA.building.rate100.depreciationDetail.propDepreciationNetAgg')[0],
			'Amount cannot be more than the amount entered in Total depreciation',
			true);
	}
	...
	if( parseInt(document.getElementsByName('scheduleDOA.furnitureFittings.rate10.depreciationDetail.propDepreciationNetAgg')[0].value) >
	parseInt(document.getElementsByName('scheduleDOA.furnitureFittings.rate10.depreciationDetail.depreciationNetAgg')[0].value)  ){
	j.setFieldError('scheduleDOA.furnitureFittings.rate10.depreciationDetail.propDepreciationNetAgg','Amount cannot be more than the amount entered in Total depreciation');
	addErrorXHTML( document.getElementsByName('scheduleDOA.furnitureFittings.rate10.depreciationDetail.propDepreciationNetAgg')[0],
			'Amount cannot be more than the amount entered in Total depreciation',
			true);
	}
	...
	if( parseInt(document.getElementsByName('scheduleDOA.intangibleAssets.rate25.depreciationDetail.propDepreciationNetAgg')[0].value) >
	parseInt(document.getElementsByName('scheduleDOA.intangibleAssets.rate25.depreciationDetail.depreciationNetAgg')[0].value)  ){
	j.setFieldError('scheduleDOA.intangibleAssets.rate25.depreciationDetail.propDepreciationNetAgg','Amount cannot be more than the amount entered in Total depreciation');
	addErrorXHTML( document.getElementsByName('scheduleDOA.intangibleAssets.rate25.depreciationDetail.propDepreciationNetAgg')[0],
			'Amount cannot be more than the amount entered in Total depreciation',
			true);
	}
	...
	if( parseInt(document.getElementsByName('scheduleDOA.ships.rate20.depreciationDetail.propDepreciationNetAgg')[0].value) >
	parseInt(document.getElementsByName('scheduleDOA.ships.rate20.depreciationDetail.depreciationNetAgg')[0].value)  ){
	j.setFieldError('scheduleDOA.ships.rate20.depreciationDetail.propDepreciationNetAgg','Amount cannot be more than the amount entered in Total depreciation');
	addErrorXHTML( document.getElementsByName('scheduleDOA.ships.rate20.depreciationDetail.propDepreciationNetAgg')[0],
			'Amount cannot be more than the amount entered in Total depreciation',
			true);
	}
...
function checkFor18thFiledValue(){

	if( parseInt(document.getElementsByName('scheduleDPM.plantMachinery.rate15.depreciationDetail.propAvgDepreciation')[0].value) >
		parseInt(document.getElementsByName('scheduleDPM.plantMachinery.rate15.depreciationDetail.netAgvDepreciation')[0].value)  ){
		j.setFieldError('scheduleDPM.plantMachinery.rate15.depreciationDetail.propAvgDepreciation','Amount cannot be more than the amount entered in Proportionate aggregate depreciation');
		addErrorXHTML( document.getElementsByName('scheduleDPM.plantMachinery.rate15.depreciationDetail.propAvgDepreciation')[0],
				'Amount cannot be more than the amount entered in Proportionate aggregate depreciation',
				true);
	}

	if( parseInt(document.getElementsByName('scheduleDPM.plantMachinery.rate30.depreciationDetail.propAvgDepreciation')[0].value) >
	parseInt(document.getElementsByName('scheduleDPM.plantMachinery.rate30.depreciationDetail.netAgvDepreciation')[0].value)  ){
		j.setFieldError('scheduleDPM.plantMachinery.rate30.depreciationDetail.propAvgDepreciation','Amount cannot be more than the amount entered in Proportionate aggregate depreciation');
		addErrorXHTML( document.getElementsByName('scheduleDPM.plantMachinery.rate30.depreciationDetail.propAvgDepreciation')[0],
				'Amount cannot be more than the amount entered in Proportionate aggregate depreciation',
				true);
	}

	if( parseInt(document.getElementsByName('scheduleDPM.plantMachinery.rate40.depreciationDetail.propAvgDepreciation')[0].value) >
	parseInt(document.getElementsByName('scheduleDPM.plantMachinery.rate40.depreciationDetail.netAgvDepreciation')[0].value)  ){
		j.setFieldError('scheduleDPM.plantMachinery.rate40.depreciationDetail.propAvgDepreciation','Amount cannot be more than the amount entered in Proportionate aggregate depreciation');
		addErrorXHTML( document.getElementsByName('scheduleDPM.plantMachinery.rate40.depreciationDetail.propAvgDepreciation')[0],
				'Amount cannot be more than the amount entered in Proportionate aggregate depreciation',
				true);
	}
}
...
function checkFor16thFiledValue(){
	...
	if( parseInt(document.getElementsByName('scheduleDPM.plantMachinery.rate15.depreciationDetail.depreciationITAct')[0].value) >
	parseInt(document.getElementsByName('scheduleDPM.plantMachinery.rate15.depreciationDetail.totalDepreciation')[0].value  )){

		console.log('dddzzxcxz');
		j.setFieldError('scheduleDPM.plantMachinery.rate15.depreciationDetail.depreciationITAct','Amount cannot be more than the amount entered in Total depreciation');
		addErrorXHTML( document.getElementsByName('scheduleDPM.plantMachinery.rate15.depreciationDetail.depreciationITAct')[0],
				'Amount cannot be more than the amount entered in Total depreciation',
				true);
	}

	if( parseInt(document.getElementsByName('scheduleDPM.plantMachinery.rate30.depreciationDetail.depreciationITAct')[0].value) >
	parseInt(document.getElementsByName('scheduleDPM.plantMachinery.rate30.depreciationDetail.totalDepreciation')[0].value ) ){
		j.setFieldError('scheduleDPM.plantMachinery.rate30.depreciationDetail.depreciationITAct','Amount cannot be more than the amount entered in Total depreciation');
		addErrorXHTML( document.getElementsByName('scheduleDPM.plantMachinery.rate30.depreciationDetail.depreciationITAct')[0],
				'Amount cannot be more than the amount entered in Total depreciation',
				true);
	}

	if(parseInt( document.getElementsByName('scheduleDPM.plantMachinery.rate40.depreciationDetail.depreciationITAct')[0].value) >
	parseInt(document.getElementsByName('scheduleDPM.plantMachinery.rate40.depreciationDetail.totalDepreciation')[0].value  )){
		j.setFieldError('scheduleDPM.plantMachinery.rate40.depreciationDetail.depreciationITAct','Amount cannot be more than the amount entered in Total depreciation');
		addErrorXHTML( document.getElementsByName('scheduleDPM.plantMachinery.rate40.depreciationDetail.depreciationITAct')[0],
				'Amount cannot be more than the amount entered in Total depreciation',
				true);
	}
}
...
function threeFieldsValidationforTDS2OnSave() {
	...
	for (var i = 0; i < mainTabRows - 6; i++) {
			...
			taxCreditedSpousePAN = document
					.getElementsByName('scheduleTDS2.tdSonOthThanSal[' + i
							+ '].taxDeductCreditDtls.taxCreditedSpousePAN')[0].value;

			if( taxCreditedIncome!='' && (taxCreditedTDS == null || taxCreditedSpousePAN==null || taxCreditedTDS == '' || taxCreditedSpousePAN==''))
				{
				j.setFieldError('scheduleTDS2.tdSonOthThanSal[' + i+ '].taxDeductCreditDtls.taxCreditedIncome',
					'Please enter all the mandatory fields in TDS2 point 10.');
				return;
				}
			if(taxCreditedTDS!='' && (taxCreditedIncome == null || taxCreditedSpousePAN==null || taxCreditedIncome == '' || taxCreditedSpousePAN==''))
			{
			...
			if( taxCreditedSpousePAN!='' && (taxCreditedIncome == null || taxCreditedTDS==null || taxCreditedIncome == '' || taxCreditedTDS==''))
			{
			j.setFieldError('scheduleTDS2.tdSonOthThanSal[' + i+ '].taxDeductCreditDtls.taxCreditedIncome',
				'Please enter all the mandatory fields in TDS2 point 10.');
			return;
...
function threeFieldsValidationforTDS3OnSave() {
	...
	for (var i = 0; i < mainTabRows - 6; i++) {
			...
			if( taxCreditedIncome!='' && (taxCreditedTDS == null || taxCreditedSpousePAN==null || taxCreditedTDS == '' || taxCreditedSpousePAN==''))
				{
				j.setFieldError('scheduleTDS3.tDS3onOthThanSal[' + i+ '].taxDeductCreditDtls.taxCreditedIncome',
					'Please enter all the mandatory fields in TDS3 point 10.');
				return;
				}
			if(taxCreditedTDS!='' && (taxCreditedIncome == null || taxCreditedSpousePAN==null || taxCreditedIncome == '' || taxCreditedSpousePAN==''))
			{
...
function validateTDS2(){
	...
	for (var i = 0; i < mainTabRows - 6; i++) {
		...
		if (taxDeductedOwnHands !='' && totTDSOnAmtPaid !=''){
			...
			j.setFieldError('scheduleTDS2.tdSonOthThanSal[' + i+ '].totTDSOnAmtPaid','Unclaimed TDS brought forward and details of TDS of current FY should be provided in different rows in Sch TDS 2.');
...
function validateTDS3(){
	...
	for (var i = 0; i < mainTabRows - 6; i++) {
		...
		if (taxDeductedOwnHands !='' && totTDSOnAmtPaid !=''){
			...
			addErrorXHTML(
					'',
					'Unclaimed TDS brought forward and details of TDS of current FY should be provided in different rows in Sch TDS 3.');
			j.setFieldError('scheduleTDS3.tDS3onOthThanSal[' + i+ '].totTDSOnAmtPaid','Unclaimed TDS brought forward and details of TDS of current FY should be provided in different rows in Sch TDS 3.');
...
function panValidationTDS2(tableId) {
	...
	var allInputTags = table.getElementsByTagName('input');
	for (var i = 0; i < allInputTags.length; i++) {
		if (allInputTags[i].name.match("taxDeductCreditDtls.taxDeductedSpousePAN$")) {
			if (allInputTags[i].value != ''
				...
				j
						.setFieldError(allInputTags[i].name,
								'PAN of spouse / other person cannot be same as PAN of the Assesse.');
			}
		}
		if (allInputTags[i].name.match("taxDeductCreditDtls.taxCreditedSpousePAN$")) {
			if (allInputTags[i].value != ''
					&& (allInputTags[i].value == pan || allInputTags[i].value == verificationPAN)) {
				// addError(allInputTags[i],'Enter the PAN of the person to whom
				// the donation is made.',true);
...
function displayWarningsForTDS1() {
	var incSal = document.getElementsByName('scheduleS.incomeChargeable')[0].value;
	var otherAllowancesSalaryTot= getTotForSalaryOtherAllowances();
	...
	if ((parseInt(coalesce(incSal), 10)+parseInt(otherAllowancesSalaryTot, 10)) < tdsSalminusTenPer) {

		j
		.setFieldError('',
				'The amount of Salary disclosed in Income details is less than 90% of salary reported in Schedule TDS 1.Please re-check the values.');
		addErrorXHTML(
...
function validateSalaryOtherAllowancesDesc(){
	var tableName = 'scheduleOtherAllow';
	var tab = document.getElementById('scheduleSalaryMain');
	var rowcount = tab.rows.length;
	var salaryCount = parseInt(rowcount / 14, 10);
	...
	for (var i = 0; i < salaryCount; i++) {
		...
		for (var m= 0; m < subTable.rows.length - 3; m++) {

			var natureDesc = document.getElementsByName('scheduleS.salaries[' + i + '].salarys.otherAllowances.othersIncDtls[' + m + '].natureDesc')[0].value;
			var othNatOfInc  = document.getElementsByName('scheduleS.salaries[' + i + '].salarys.otherAllowances.othersIncDtls[' + m 	+ '].othNatOfInc')[0].value;
			var othNatOfAmt  = document.getElementsByName('scheduleS.salaries[' + i + '].salarys.otherAllowances.othersIncDtls[' + m 	+ '].othAmount')[0].value;

				if (natureDesc == 'OTH' && othNatOfInc == '') {

					addErrorXHTML(
							'',
							'Please enter the description for the Nature of Income.');

					j.setFieldError('scheduleS.salaries[' + i + '].salarys.otherAllowances.othersIncDtls[' + m + '].othNatOfInc',
							'Please enter the description for the Nature of Income.');

				return;
				}
				
				if (natureDesc == 'OTH' && othNatOfInc != '' && othNatOfAmt == '') {

					addErrorXHTML(
							'',
							'Please enter the Amount');

					j.setFieldError('scheduleS.salaries[' + i + '].salarys.otherAllowances.othersIncDtls[' + m + '].othNatOfAmt',
							'Please enter the Amount.');
...
function getTotForSalaryOtherAllowances(){

	var mainTable = document.getElementById('scheduleSalaryMain').rows;
	var mainTableRows = mainTable.length;
	var lastIndex=eval(parseInt(mainTableRows,10)-3);

	var rowCount = mainTable[lastIndex].getElementsByTagName('table')[0].id.substring(18);
	var otherAllowancesSalaryTot = 0;

	for (var i = 0; i < rowCount; i++) {

		otherAllowancesSalaryTot = otherAllowancesSalaryTot
				+ eval(parseInt(coalesce(document.getElementsByName('scheduleS.salaries['+i+'].salarys.otherAllowances')[0].value), 10));

	}
	return otherAllowancesSalaryTot;
}

function picodeDisable(){


	if(document
			.getElementsByName('partAGEN1.personalInfo.address.country')[0].value!='91'){
		document
		.getElementsByName('partAGEN1.personalInfo.address.pinCode')[0].disabled=true;

	}

}

function onBPTableWithSingleDropMand(){

	var sss43 = document
	.getElementsByName('itr4ScheduleBP.specifiedBusinessInc.netPLFrmSpecifiedBus')[0].value;

	if(sss43!=0){
		if(document
				.getElementsByName('itr4ScheduleBP.specifiedBusinessInc[0].35AD')[0].value==''){

			addErrorXHTML(
					'',
					'Please select any Relevant clause of sub-section (5) of section 35AD from dropdown (Schedule BP Sl No 49');

			j.setFieldError('',
					'Please select  Relevant clause of sub-section (5) of section 35AD from dropdown (Schedule BP Sl No 49)');

		}
	}
}

function populateSTCGSectionCode(elem,subCatVal){
	var index = elem.selectedIndex - 1;
	var name = elem.name;
	var row = name.substring(name.indexOf('[')+1,name.indexOf(']'));
	var subCat = document.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.unUtilizedCapGain54[' + row + '].section')[0];
	...
	if(index==0){
		subCat.options[1]=new Option('54D','54D');
		subCat.options[2]=new Option('54G','54G');
		subCat.options[3]=new Option('54GA','54GA');
	}
	else if(index==1){
		subCat.options[1]=new Option('54B','54B');
	}
	if(tempVal.length==0){
		subCat.value = "-1";
	}
...
function populateLTCGSectionCode(elem,subCatVal){
	var index = elem.selectedIndex - 1;
	var name = elem.name;
	var row = name.substring(name.indexOf('[')+1,name.indexOf(']'));
	var subCat = document.getElementsByName('scheduleCGPost45.longTermCapGainPost45.unUtilizedCapGain54[' + row + '].section')[0];
	...
	if(index==0){
		subCat.options[1]=new Option('54','54');
		subCat.options[2]=new Option('54D','54D');
		subCat.options[3]=new Option('54F','54F');
		subCat.options[4]=new Option('54G','54G');
		subCat.options[5]=new Option('54GA','54GA');
	}
	else if(index==1){
		subCat.options[1]=new Option('54B','54B');
	}
...
function validateTCS(){
	...
	for (var i = 0; i < mainTabRows - 5; i++) {
			var amtbfTCS = document.getElementsByName('itr4.scheduleTCS.tcs[' + i + '].amountBF')[0].value;
			var totTCS = document.getElementsByName('itr4.scheduleTCS.tcs[' + i + '].totalTCS')[0].value ;
		...
		if (amtbfTCS !='' && totTCS !=''){
			...
			addErrorXHTML(
					'',
					'Unclaimed TCS brought forward and details of TCS of current FY should be provided in different rows in Sch TCS');
			j.setFieldError('itr4.scheduleTCS.tcs[' + i + '].totalTCS','Unclaimed TCS brought forward and details of TCS of current FY should be provided in different rows in Sch TCS');
...
function populateSTCGSecCode(){

	var tableId  = document.getElementById('scheduleStcgunUtilizedCapGain54').rows;
	var rowCount = tableId.length;

	for (var i = 0; i < rowCount-3; i++) {


		var subCat = document.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.unUtilizedCapGain54[' + i + '].section')[0];
		var ay = document.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.unUtilizedCapGain54[' + i + '].ay')[0].selectedIndex-1;
		var tempVal = subCat.value;
		...
		if(tempVal.length==0){
			document.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.unUtilizedCapGain54[' + i + '].section')[0].value = "";
		}
		else{
			document.getElementsByName('scheduleCGPost45.shortTermCapGainPost45.unUtilizedCapGain54[' + i + '].section')[0].value = tempVal;
		}
	}
}

function populateLTCGSecCode(){

	var tableId  = document.getElementById('scheduleLtcgunUtilizedCapGain54').rows;
	var rowCount = tableId.length;

	for (var i = 0; i < rowCount-3; i++) {


		var subCat = document.getElementsByName('scheduleCGPost45.longTermCapGainPost45.unUtilizedCapGain54[' + i + '].section')[0];
		var ay = document.getElementsByName('scheduleCGPost45.longTermCapGainPost45.unUtilizedCapGain54[' + i + '].ay')[0].selectedIndex-1;
		var tempVal = subCat.value;
		...
		if(tempVal.length==0){
			document.getElementsByName('scheduleCGPost45.longTermCapGainPost45.unUtilizedCapGain54[' + i + '].section')[0].value = "";
		}
		else{
			document.getElementsByName('scheduleCGPost45.longTermCapGainPost45.unUtilizedCapGain54[' + i + '].section')[0].value = tempVal;
		}
	}
...
function validateDedUs54()
{
	...
	var	date = document
		.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54[' + i + '].dateofTransfer')[0].value;
		
	var	cost = document
		.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54[' + i + '].costofNewResHouse')[0].value;
	var	dateofPurchase = document
	.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54[' + i + '].dateofPurchase')[0].value;
	var	amtDeposited = document
	.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54[' + i + '].amtDeposited')[0].value;
	
	if(date != '')
		{
		if(cost != '' && dateofPurchase == '')
			{
			addErrorXHTML(
					'',
					'Please enter the date of purchase.');

			j.setFieldError('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54[' + i + '].dateofPurchase',
					'Please enter the date of purchase.');

		return;
			} 
		
		if(dateofPurchase != '' && cost == '')
				{
				addErrorXHTML(
						'',
						'Please enter the cost of new residential house.');

				j.setFieldError('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54[' + i + '].costofNewResHouse',
						'Please enter the cost of new residential house.');

			return;
				} 
			
			if(dateofPurchase == '' && cost == '' && amtDeposited == '')
					{
				addErrorXHTML(
						'',
						'Please fill either Cost of new residential house & Date of purchase/construction or Amount deposited in Deduction claimed u/s 54');
...
function validateDedUs54B()
{
	var tab = document.getElementById('schduleCGDedD1B');
	var noOfRows = tab.rows.length;

	for (var i = 0; i < (noOfRows - 2); i++) {
		
	var	date = document
		.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54B[' + i + '].dateofTransfer')[0].value;
		
	var	cost = document
		.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54B[' + i + '].costofNewAgriLand')[0].value;
	
	var	dateofPurchase = document
	.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54B[' + i + '].dateofPurchase')[0].value;
	
	var	amtDeposited = document
	.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54B[' + i + '].amtDeposited')[0].value;
	...
	if(date != '')
		...
		if(cost != '' && dateofPurchase == '')
			...
			j.setFieldError('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54B[' + i + '].dateofPurchase',
					'Please enter the date of purchase.');
		...
		if(dateofPurchase != '' && cost == '')
				...
				j.setFieldError('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54B[' + i + '].costofNewAgriLand',
						'Please enter the cost of new residential house.');
		...
		if(dateofPurchase == '' && cost == '' && amtDeposited == '')
			...
			addErrorXHTML(
					'',
					'Please fill either Cost of new agricultural land & Date of purchase or Amount deposited in Deduction claimed u/s 54B');
...
function validateDedUs54D()
{
	var tab = document.getElementById('schduleCGDedD1C');
	var noOfRows = tab.rows.length;

	for (var i = 0; i < (noOfRows - 2); i++) {
		
	var	date = document
		.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54D[' + i + '].dateofTransfer')[0].value;
		
	var	cost = document
		.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54D[' + i + '].costofNewResHouse')[0].value;
	
	var	dateofPurchase = document
	.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54D[' + i + '].dateofPurchase')[0].value;
	
	var	amtDeposited = document
	.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54D[' + i + '].amtDeposited')[0].value;
	...
	if(date != '')
		...
		if(cost != '' && dateofPurchase == '')
			...
			j.setFieldError('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54D[' + i + '].dateofPurchase',
					'Please enter the date of purchase.');
		...
		if(dateofPurchase != '' && cost == '')
				...
				j.setFieldError('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54D[' + i + '].costofNewResHouse',
						'Please enter the cost of new residential house.');
		...
		if(dateofPurchase == '' && cost == '' && amtDeposited == '')
			...
			addErrorXHTML(
					'',
					'Please fill either Cost of purchase/construction & Date of purchase or Amount deposited in Deduction claimed u/s 54D');
...
function validateDedUs54F()
{
	var tab = document.getElementById('schduleCGDedD1F');
	var noOfRows = tab.rows.length;

	for (var i = 0; i < (noOfRows - 2); i++) {
		
	var	date = document
		.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54F[' + i + '].dateofTransfer')[0].value;
		
	var	cost = document
		.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54F[' + i + '].costofNewResHouse')[0].value;
	
	var	dateofPurchase = document
	.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54F[' + i + '].dateofPurchase')[0].value;
	
	var	amtDeposited = document
	.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54F[' + i + '].amtDeposited')[0].value;
	...
	if(date != '')
		...
		if(cost != '' && dateofPurchase == '')
			...
			j.setFieldError('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54F[' + i + '].dateofPurchase',
					'Please enter the date of purchase.');
		...
		if(dateofPurchase != '' && cost == '')
				...
				j.setFieldError('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54F[' + i + '].costofNewResHouse',
						'Please enter the cost of new residential house.');
		...
		if(dateofPurchase == '' && cost == '' && amtDeposited == '')
			...
			addErrorXHTML(
					'',
					'Please fill either Cost of new residential house & Date of purchase/construction or Amount deposited in Deduction claimed u/s 54F');
...
function validateDedUs54G()
{
	var tab = document.getElementById('schduleCGDedD1G');
	var noOfRows = tab.rows.length;

	for (var i = 0; i < (noOfRows - 2); i++) {
		
	var	date = document
		.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54G[' + i + '].dateofTransfer')[0].value;
		
	var	cost = document
		.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54G[' + i + '].costofNewResHouse')[0].value;
	
	var	dateofPurchase = document
	.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54G[' + i + '].dateofPurchase')[0].value;
	
	var	amtDeposited = document
	.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54G[' + i + '].amtDeposited')[0].value;
	...
	if(date != '')
		...
		if(cost != '' && dateofPurchase == '')
			...
			j.setFieldError('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54G[' + i + '].dateofPurchase',
					'Please enter the date of purchase.');
		...
		if(dateofPurchase != '' && cost == '')
				...
				j.setFieldError('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54G[' + i + '].costofNewResHouse',
						'Please enter the cost of new residential house.');
		...
		if(dateofPurchase == '' && cost == '' && amtDeposited == '')
			...
			addErrorXHTML(
					'',
					'Please fill either Cost and expenses & Date of purchase/construction or Amount deposited in Deduction claimed u/s 54G');
...
function validateDedUs54GA()
{
	var tab = document.getElementById('schduleCGDedD1H');
	var noOfRows = tab.rows.length;

	for (var i = 0; i < (noOfRows - 2); i++) {
		
	var	date = document
		.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54GA[' + i + '].dateofTransfer')[0].value;
		
	var	cost = document
		.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54GA[' + i + '].costofNewResHouse')[0].value;
	
	var	dateofPurchase = document
	.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54GA[' + i + '].dateofPurchase')[0].value;
	
	var	amtDeposited = document
	.getElementsByName('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54GA[' + i + '].amtDeposited')[0].value;
	...
	if(date != '')
		...
		if(cost != '' && dateofPurchase == '')
			...
			j.setFieldError('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54GA[' + i + '].dateofPurchase',
					'Please enter the date of purchase.');
		...
		if(dateofPurchase != '' && cost == '')
				...
				j.setFieldError('scheduleCGPost45.deducClaimInfo.deducClaimDtlsUs54GA[' + i + '].costofNewResHouse',
						'Please enter the cost of new residential house.');
			...
			if (dateofPurchase == '' && cost == '' && amtDeposited == '') {
				addErrorXHTML(
						'',
						'Please fill either Cost and expenses & Date of purchase/construction or Amount deposited in Deduction claimed u/s 54GA');
...
function schIFmandatory()
{

	var tab = document.getElementById('natOfBustTradeTableId');
	var noOfRows = tab.rows.length;

	for (var i = 0; i < (noOfRows - 2); i++) {
		var	code = document.getElementsByName('partAGEN2For4.natOfBus.natureOfBusiness[' + i + '].code')[0].value;
		
		if(code == '00001')
			{
			var blankSchIf= checkRowBlank('scheduleIF', 3, 1);
			if(blankSchIf){
				j.setFieldError('','Please enter Schedule IF');
				addErrorXHTML('','Please enter Schedule IF',true);
			}
			}
